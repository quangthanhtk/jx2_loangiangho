...
function OnUse(nItem)
	local tbSay = {
	format("§æi kinh nghiÖm (1 m¶nh Thiªn Cang=%d kinh nghiÖm)/exchange_exp", Exp_cost),
	format("§æi Thiªn Cang LÖnh (%d m¶nh Thiªn Cang=1 Thiªn Cang LÖnh)/exchange_tgl", Item_cost),
	"Tho¸t/nothing",
	};
