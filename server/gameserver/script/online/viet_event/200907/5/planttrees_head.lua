...
--»î¶¯¿ªÊ¼½áÊøÈÕÆÚ
PT_START_DATE = 20201124 
PT_END_DATE	  = 20210103

ACT_DATE_START	= 20201124 --Christmas trees start date
ACT_DATE_END	= 20210103 --Christmas trees end date
...
TREE_TYPE = {									--Ä£°åÃû£¬NPCÃû×Ö£¬³öÏÖ¸ÅÂÊ
				...
				{"MÇm Hoa hång", "C©y BÊt Tö", 0.1, "C©y BÊt Tö"},
				{" nh¸nh hoa hång", "C©y B¹ch Ng©n", 90, "C©y B¹ch Ng©n"},
				{"c©y §a MËt Hoa Qu¶ nhá", "C©y Hoµng Kim", 4, "C©y Hoµng Kim"},
				{"c©y §a MËt Hoa Qu¶ lín", "C©y B¹ch Kim", 0.9, "C©y B¹ch Kim"},
			}
end
...
function checkEventDate()		--¼ì²é»î¶¯ÈÕÆÚ2009Äê04ÔÂ24ÈÕ¡¡-- 2009Äê05ÔÂ31ÈÕ24µã
	...
	if nDate >= PT_START_DATE and nDate <= PT_END_DATE then
		return 1;
	end
	return 0;
end
