...
function npc_xiao_talk()
	...
	Say(szNpcName.."Sù kiÖn <color=green>Mõng Xu©n Canh DÇn<color> diÔn ra tõ ngµy <color=yellow>29-01-2010 ®Õn 24:00 ngµy 28-02-2010<color>. Th«ng tin chi tiÕt c¸c ho¹t ®éng ®ång ®¹o cã thÓ xem t¹i trang chñ.",getn(tSay),tSay);
end
