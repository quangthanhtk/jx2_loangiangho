...
function main()
	...
	--if nPhucSinh < 3 then --LongDaiKa: më phôc sinh 2
...
function confirm_task_thonuong()
	...
	if DelItem(2,97,236,10) ~= 1 then
		Talk ( 1 , "", szNpcName.." CÇn 10 Thiªn Kiªu LÖnh  nhËn nhiÖm vô!" )
		return
	end
...
function New_reward082018()
	...
	gf_AddItemEx2({1, 0, 31239, 1}, "Linh ph¸ch §¬n", "Nhiem vu Tho Nuong Bach Tien Sinh", "nhËn th­ëng nhiÖm vô thá n­íng")
	gf_AddItemEx2({2, 102, 215, 100}, "Bét tr©n ch©u", "Nhiem vu Tho Nuong Bach Tien Sinh", "nhËn th­ëng nhiÖm vô thá n­íng")
...
function PS2_finishTask()
	...
	local tbSayDialog = {};
	local nSaySize = 0;
	local szSayHead = "Th«ng tin chi tiÕt vÒ <color=yellow>Phôc Sinh lÇn 2<color> ®ång ®¹o cã thÓ xem t¹i trang chñ."
