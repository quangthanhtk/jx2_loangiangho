...
function DenBu_NhanMatTich()
	...
	local tblMatTichCaoCap = {
			...
			[25] = {item = {0, 107, 219, 1}, name ="Håi Phong Tr¶m NhËt Ch©n QuyÓn"},
			[26] = {item = {0, 107, 220, 1}, name ="Phô Kú Hµnh TrËn Ch©n QuyÓn"},
			[27] = {item = {0, 107, 221, 1}, name ="Ng­ng HuyÕt Phong Hån Ch©n QuyÓn"},
			[29] = {item = {0, 107, 222, 1}, name ="Hång TrÇn Tóy Méng Ch©n QuyÓn"},
			[30] = {item = {0, 107, 223, 1}, name ="Phong Hoa Thiªn DiÖp Ch©n QuyÓn"},
			[31] = {item = {0, 107, 231, 1}, name ="Mª Tung Ch©n QuyÓn"},
			[32] = {item = {0, 107, 235, 1}, name ="Thiªn Phong Ch©n QuyÓn"},
		}
