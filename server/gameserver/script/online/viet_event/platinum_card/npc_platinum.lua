...
function award_level_BKL()
	...
	Say("<color=green>Chñ Phßng M¸y<color>: §èi víi c¸c tµi kho¶n cã <color=yellow>L«i Hæ LÖnh<color>, khi ®¹t ®­îc c¸c mèc ®iÒu kiÖn nhËn th­ëng (chi tiÕt xem t¹i trang chñ), c¸c h¹ cã thÓ ®Õn gÆp ta ®Ó nhËn phÇn th­ëng.",	getn(tSay),tSay)
end
