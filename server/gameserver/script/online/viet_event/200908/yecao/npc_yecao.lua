...
--	end
	tinsert(tbSayDialog, "Mua 1 ®ång tiÒn vµng (tiªu hao 100 vµng)/buy_goldmetal")
...
function buy_goldmetal()
		if GetCash() < 1000000 then
			Say("D¹ Th¶o: Sè tiÒn c¸c h¹ mang theo kh«ng ®ñ!",0)
			return 0
		end
		if gf_Judge_Room_Weight(1,100) ~= 1 then
			Talk(1,"","D¹ Th¶o: Hµnh trang cña c¸c h¹ kh«ng ®ñ « trèng hoÆc ®é nÆng!")
			return
		end
		if Pay(1000000) == 1 then
			gf_AddItemEx2({2, 1, 30094,1}, "mua dong tien vang", "Mua Dong Tien", "mua ®ång tiÒn vµng")	
		end
end
