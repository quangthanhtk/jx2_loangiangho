...
function get_translife_item()
	if GetTranslifeFaction() == 0 and GetPlayerRebornParam(1) == 0 then
		Talk(1,"",szNpcName.."Hçn Nguyªn C«ng tung hoµnh thiªn h¹, mÊy ai lÜnh héi ®­îc?")
		return	
	end	
...
function confirm_get_translife_item()
	...
	if GetTranslifeFaction() == 0 and GetPlayerRebornParam(1) == 0 then
		Talk(1,"",szNpcName.."B¹n ch­a chuyÓn sinh hoÆc Phôc Sinh")
		return	
	end
	...
	if nNumberPS == 4 or nNumberPS == 5 then
		if GetCash() < 500000 then
			Talk(1,"",szNpcName.." CÇn 50 vµng ®Ó nhËn l¹i vËt phÈm.")
			return	
		end
	end
	if gf_JudgeRoomWeight(8,300,szNpcName) == 0 then
		return
	end	
	...
	---------chuyÓn sinh 10 - Phôc Sinh 5
	if GetPlayerRebornParam(0) == 5 then
	...
	--	local nBody_cs6 = GetBody()
		for i=1, getn(tb_translife_cloth_cs8_nhanlai[nType_cs7][nBody]) do
			local G,D,P,nCount, _, lvatt1, att1, lvatt2, att2, lvatt3, att3  = gf_UnPack(tb_translife_cloth_cs8_nhanlai[nType_cs7][nBody][i])
			--P = P + GetBody() - 1
			lvatt3 = lvatt3 or 0
			att3 = att3 or 0
			BigDelItem(G,D,P,BigGetItemCount(G,D,P))
		...
		for i=1, getn(t_translife_uanlinh_cs_ps[nNumberPS][nTypePS]) do
			local G,D,P,nCount, _, lvatt1, att1, lvatt2, att2, lvatt3, att3  = gf_UnPack(t_translife_uanlinh_cs_ps[nNumberPS][nTypePS][i])
			--P = P + GetBody() - 1
			lvatt3 = lvatt3 or 0
			att3 = att3 or 0
			BigDelItem(G,D,P,BigGetItemCount(G,D,P))
...
--		end	
		for i = 1, 3 do
			gf_AddItemEx(tb_translife_cloth_cs10_nhanlai[nBody][i], "NhËn l¹i trang bÞ")
			gf_AddItemEx2(t_translife_uanlinh_cs_ps[nNumberPS][nTypePS][i], " Bé uÈn linh", "Bo uan linh 10","nhËn", 30*24*3600, "NhËn trang bÞ thµnh c«ng")		
		end		
		...
		WriteLogEx("Chuyen Sinh","nhËn l¹i Ên vµ ngo¹i trang chuyÓn sinh 10 theo h­íng "..tb_translife_seal[nType_cs7][3])		
		return	
	end
	---------chuyÓn sinh 9 - Phôc Sinh 4
	...
	--	local nBody_cs6 = GetBody()
		...
		local nNumberPS = GetPlayerRebornParam(0)	
		for i = 1, 3 do
			gf_AddItemEx(tb_translife_cloth_cs9_nhanlai[nBody][i], "NhËn l¹i trang bÞ")
			gf_AddItemEx2(t_translife_uanlinh_cs_ps[nNumberPS][nTypePS][i], " Bé uÈn linh", "Bo uan linh 9","nhËn", 30*24*3600, "NhËn trang bÞ thµnh c«ng")		
		end
		for i=1, getn(tb_translife_cloth[nType][nTransCount]) do
			local G,D,P,nCount, _, lvatt1, att1, lvatt2, att2, lvatt3, att3  = gf_UnPack(tb_translife_cloth[nType][nTransCount][i][2])
			P = P + GetBody() - 1
		...
		Talk(1,"","§©y lµ nh÷ng vËy quý gi¸, lÇn sau cÈn thËn ko ®Ó mÊt n÷a ®Êy!")	
		WriteLogEx("Chuyen Sinh","nhËn l¹i Ên vµ ngo¹i trang chuyÓn sinh 9 theo h­íng "..tb_translife_seal[nType_cs7][3])		
		return	
	end
	---------chuyÓn sinh 8 - Phôc Sinh 3
...
--		Pay(500000)
	...
	--	local nBody_cs6 = GetBody()
		...
		local nNumberPS = GetPlayerRebornParam(0)		
		for i = 1, 3 do
			gf_AddItemEx(tb_translife_cloth_cs8_nhanlai[nType_cs7][nBody][i], "NhËn l¹i trang bÞ")
--			gf_AddItemEx2(t_translife_uanlinh_cs_ps[nNumberPS][nTypePS][i], " Bé uÈn linh", "Bo uan linh 8","nhËn", 30*24*3600, "NhËn trang bÞ thµnh c«ng")		
		end
		for i=1, getn(tb_translife_cloth[nType][nTransCount]) do
			local G,D,P,nCount, _, lvatt1, att1, lvatt2, att2, lvatt3, att3  = gf_UnPack(tb_translife_cloth[nType][nTransCount][i][2])
			P = P + GetBody() - 1
		...
		Talk(1,"","§©y lµ nh÷ng vËy quý gi¸, lÇn sau cÈn thËn ko ®Ó mÊt n÷a ®Êy!")	
		WriteLogEx("Chuyen Sinh","nhËn l¹i Ên vµ ngo¹i trang chuyÓn sinh 8 theo h­íng "..tb_translife_seal[nType_cs7][3])		
		return
	end	
	---------chuyÓn sinh 6
...
--			gf_AddItemEx2(t_translife_uanlinh_cs_ps[nNumberPS][nTypePS][i], " Bé uÈn linh", "Bo uan linh 6","nhËn", 30*24*3600, "NhËn trang bÞ thµnh c«ng")	
		end
--		for i=1, getn(tb_translife_cloth[nType][nTransCount]) do
--			local G,D,P,nCount, _, lvatt1, att1, lvatt2, att2, lvatt3, att3  = gf_UnPack(tb_translife_cloth[nType][nTransCount][i][2])
--			P = P + GetBody() - 1
...
--			gf_AddItemEx2(t_translife_uanlinh_cs_ps[nNumberPS][nTypePS][i], " Bé uÈn linh", "Bo uan linh 7","nhËn", 30*24*3600, "NhËn trang bÞ thµnh c«ng")	
		end
--		for i=1, getn(tb_translife_cloth[nType][nTransCount]) do
--			local G,D,P,nCount, _, lvatt1, att1, lvatt2, att2, lvatt3, att3  = gf_UnPack(tb_translife_cloth[nType][nTransCount][i][2])
--			P = P + GetBody() - 1
