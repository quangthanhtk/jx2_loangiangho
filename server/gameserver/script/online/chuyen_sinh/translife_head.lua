...
tb_translife_tittle = 
{
	[1] = 	{
				...
				[25] = {"NhËp Quan ®¹o nh©n", 24, 15},	
				[26] = {"NhËp Quan ®¹o nh©n", 24, 16},	
				[27] = {"NhËp Quan ®¹o nh©n", 24, 17},	
				[29] = {"Vò Y Sø", 24, 5},	
				[30] = {"Ph¹n ¢m Sø", 24, 6},	
				[31] = {"Hé VÖ", 24, 4},	
	...
	[2] = 	{
				...
				[23] = {"V« ng· ®¹o nh©n", 25, 9},		
				[25] = {"V« ng· ®¹o nh©n", 25, 15},		
				[26] = {"V« ng· ®¹o nh©n", 25, 16},		
				[27] = {"V« ng· ®¹o nh©n", 25, 17},		
				[29] = {"Tö Tróc sø", 25, 5},	
	...
	[3] =	{		
				...
				[25] = {"Ch­ëng Kinh ®¹o nh©n", 26, 15},	
				[26] = {"Ch­ëng Kinh ®¹o nh©n", 26, 16},	
				[27] = {"Ch­ëng Kinh ®¹o nh©n", 26, 17},	
	...
	[4] =	{
				...
				[25] = {"Th­îng Thanh §¹o Nh©n", 27, 15},	
				[26] = {"Th­îng Thanh §¹o Nh©n", 27, 16},	
				[27] = {"Th­îng Thanh §¹o Nh©n", 27, 17},	
	...
	[5] = {
				...
				[25] = {"Th­îng Thanh ch©n nh©n", 28, 15},		
				[26] = {"Th­îng Thanh ch©n nh©n", 28, 16},		
				[27] = {"Th­îng Thanh ch©n nh©n", 28, 17},		
...
t_translife_uanlinh_cs_ps = {
						[1] = {--Phôc sinh 1
									[1] = {{0,148,121,1,4,-1,-1,-1,-1,-1,-1}, {0,149,125,1,4,-1,-1,-1,-1,-1,-1}, {0,150,121,1,4,-1,-1,-1,-1,-1,-1}}, --kiÓu h×nh
...
tb_translife_cloth_cs6_nhanlai = {
			[1] = {
					...
					[5] = {{0,108,30005,1,4}, {0,109,30005,1,4}, {0,110,30005,1,4}},
					[6] = {{0,108,30006,1,4}, {0,109,30006,1,4}, {0,110,30006,1,4}},
					[7] = {{0,108,30007,1,4}, {0,109,30007,1,4}, {0,110,30007,1,4}},
					[8] = {{0,108,30008,1,4}, {0,109,30008,1,4}, {0,110,30008,1,4}},					
				},		
			[2] = {
...
tb_translife_cloth_cs8_nhanlai = {
			[1] = {--Long
					...
					[5] = {{0,108,680,1,4}, {0,109,680,1,4}, {0,110,680,1,4}},
					[6] = {{0,108,681,1,4}, {0,109,681,1,4}, {0,110,681,1,4}},
					[7] = {{0,108,682,1,4}, {0,109,682,1,4}, {0,110,682,1,4}},
					[8] = {{0,108,683,1,4}, {0,109,683,1,4}, {0,110,683,1,4}},
				},
			[4] = {--Phông
...
tb_translife_cloth_cs10_nhanlai = {
