...
tGaojiMiji = {
	...
	[25] = {{"Håi Phong Tr¶m NhËt MËt TÞch",0,107,199}},	
	[26] = {{"Phô Kú Hµnh TrËn MËt TÞch",0,107,200}},	
	[27] = {{"Ng­ng HuyÕt Phong Hån MËt tÞch",0,107,201}},	
	[29] = {{"Hång TrÇn Tóy Méng Phæ",0,107,202}},
	[30] = {{"Phong Hoa Thiªn DiÖp Phæ",0,107,203}},	
	[31] = {{"Mª Tung",0,107,230}},
	[32] = {{"Thiªn Phong",0,107,234}},
};
