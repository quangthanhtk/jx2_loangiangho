...
Include("\\script\\warlord\\online_activities\\giftcode_alphatest\\main.lua");
Include("\\script\\warlord\\online_activities\\ruong_hoat_dong\\main.lua");
----------------------------------------------------------------------------------------------------
...
function main()
	...
	if oly_IsActivityOpen() == 1 then
		g_Act_Count = g_Act_Count + 1;
		g_Act_Dialog[g_Act_Count] = {};
		g_Act_Select[g_Act_Count] = "Th¸nh Háa §µn";
	...
	if sp_IsOpenActivity() == 1 then
		g_Act_Count = g_Act_Count + 1;
		g_Act_Dialog[g_Act_Count] = {};
		g_Act_Select[g_Act_Count] = "Ho¹t ®éng TÕt 2018";
...
--		g_Act_Count = g_Act_Count + 1;
--		g_Act_Dialog[g_Act_Count] = {};
--		g_Act_Select[g_Act_Count] = "CDKEY»î¶¯";
...
--		g_Act_Count = g_Act_Count + 1;
--		g_Act_Dialog[g_Act_Count] = {}
--		g_Act_Select[g_Act_Count] = "Ñµ³è»î¶¯";
...
--	end
	...
	if is_in_activity_date() == 1 then
		g_Act_Count = g_Act_Count + 1;
		g_Act_Dialog[g_Act_Count] = {}
		g_Act_Select[g_Act_Count] = "Ho¹t ®éng §oan Ngä";
	...
	if WLib:IsTestServer() == WEnv.TRUE and g_WCFG_GIFTCODE_ALPHATEST:IsDateOpen() == WEnv.TRUE and g_WCFG_GIFTCODE_ALPHATEST.bTaskReqEnable == WEnv.TRUE then
		g_Act_Count = g_Act_Count + 1;
		g_Act_Dialog[g_Act_Count] = {}
		g_Act_Select[g_Act_Count] = WGIFTCODE_ALPHATEST.tbActivityInfo.szActivityName;
		for i = 1, getn(WGIFTCODE_ALPHATEST.tbActivityInfo.tbActivitySayOption) do
			tinsert(g_Act_Dialog[g_Act_Count], WGIFTCODE_ALPHATEST.tbActivityInfo.tbActivitySayOption[i]);
		end
		g_Act_Title[g_Act_Count] = WGIFTCODE_ALPHATEST.tbActivityInfo.szActivitySayTitle;
	end

	if g_WCFG_RUONGHOATDONG:IsDateOpen() == WEnv.TRUE then
		g_Act_Count = g_Act_Count + 1;
		g_Act_Dialog[g_Act_Count] = {}
		g_Act_Select[g_Act_Count] = WRUONGHD.tbActivityInfo.szActivityName;
		for i = 1, getn(WRUONGHD.tbActivityInfo.tbActivitySayOption) do
			tinsert(g_Act_Dialog[g_Act_Count], WRUONGHD.tbActivityInfo.tbActivitySayOption[i]);
		end
		g_Act_Title[g_Act_Count] = WRUONGHD.tbActivityInfo.szActivitySayTitle;
	end
