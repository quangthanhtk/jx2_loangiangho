...
function main()
	...
	Say("<color=green>§¹i sø ho¹t ®éng: <color>Chµo mõng ®Õn víi phiªn b¶n míi, Thiªn TÇm Th¸p Tµng HuyÒn C¬, kÞch chiÕn boss tranh ®o¹t m¶nh, phÇn th­ëng hÊp dÉn ®ang ®îi b¹n ®Õn lÊy!",getn(tbSay),tbSay);
end
