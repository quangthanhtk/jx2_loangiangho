...
{
	"Ho¹t ®éng %s diÔn ra trong thêi gian tõ <color=yellow>ngµy 25 th¸ng 2 n¨m 2011 ®Õn 24 giê ngµy 27 th¸ng 3 n¨m 2011<color>, néi dung chi tiÕt t¹i trang chñ.",
	"®æi kÑo ngät",
	"§æi %s (cÇn %d %s + %d %s)",
...
{
    [1] = "Ho¹t ®éng mõng Gi¸ng Sinh sÏ ®­îc diÔn ra vµo ngµy 10/12/2010 ®Õn 24 giê ngµy 9/1/2011. Víi nhiÒu ho¹t ®éng vµ phÇn th­ëng hÊp dÉn, th«ng tin chi tiÕt xem thªm t¹i trang chñ.",
