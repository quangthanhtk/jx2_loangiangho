...
function buy_item_for_plant_4_soul()
    ...
    Say(VET_201012_04_NPC_TALK_STRINGS[21], 5,
            VET_201012_04_NPC_TALK_STRINGS[22].."/give_4_soul_tree",
...
function give_4_soul_tree()
	...
	local tSay = {}
	tinsert(tSay,"Mua C©y Tø Linh (15 xu)/give_4_soul_tree")
	tinsert(tSay,"Rêi khái/gf_DoNothing")
	Say("<color=yellow>B¸ch Th¶o Tiªn<color>: ".."C¸c h¹ cÇn g×?", getn(tSay),tSay)
end
