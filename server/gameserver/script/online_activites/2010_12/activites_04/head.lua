...
VET_4_SOUL_TREE_END_TIME = 0 --2011121200; --end time
...
VET_4_SOUL_MAX_PLANT_TIMES = 30;--max tree plant award,should be the same as pet level.

VET_4_TB_PLANT_MAP = {301, 203, 108};

--base condition check,pass return 1,else return 0
function base_check() 
    if GetLevel() < 59 or GetPlayerRoute() == 0 then	--or GetReputation() < 3000 or GetTask(336) < 4000
