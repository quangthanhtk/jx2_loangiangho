...
VET_201012_04_STR_LOG_TITLE = "[Ho¹t ®éng gi¸ng sinh th¸ng 12 n¨m 2010]";--±¾´Î»î¶¯ÈÕÖ¾±êÌâ
...
VET_201012_04_NPC_TALK_STRINGS = {
    ...
    [2] = "Mua c©y Tø Linh vµ nguyªn liÖu trång c©y Tø Linh/buy_item_for_plant_4_soul",
    ...
    [15] = "Nh©n vËt cÇn ®¹t trªn cÊp 59, ®· gia nhËp m«n ph¸i",	--, danh väng = 3000, ®iÓm s­ m«n = 4000
...
VET_201012_04_TB_AWARD = {
    ...
    [3] = {{0, 0, 15, 0}, 1500000},
    [4] = {{0, 0, 0, 15}, 1500000},
    [5] = {{15, 15, 15, 15}, 6000000}, --ÐèÒª4ÖÖË®¹û¸÷15¸ö
};
...
VET_201012_04_TB_TREE_GROW = {
    [1] = {"C©y gièng", "C©y Gi¸ng sinh 3d",nil, 30},
    ...
    [7] = {"Thu ho¹ch", "C©y Gi¸ng sinh 3a", nil, 30},
};
else
VET_201012_04_TB_TREE_GROW = {
    [1] = {"C©y gièng", "C©y Tø Linh 1",nil, 30},
    ...
    [7] = {"Thu ho¹ch", "C©y Tø Linh 4", nil, 30},
};
end
