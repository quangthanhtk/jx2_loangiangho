...
--describe:Ô½ÄÏ°æ2010Äê9ÔÂ»î¶¯1 ×Ö·û´®ÎÄ¼þ
--=============================================
...
VET_201009_01_TB_STRING_LIST = {
    [1] = "B¸nh ®· qu¸ h¹n sö dông, kh«ng thÓ dïng ®­îc n÷a",
    [2] = "<color=yellow>Ho¹t ®éng Trung Thu<color> b¾t ®Çu tõ <color=red>ngµy 17/9/2010 ®Õn ngµy 24/10/2010<color>. Néi dung chi tiÕt vui lßng t×m hiÓu t¹i trang chñ.",
    [3] = "\nTa muèn lµm b¸nh trung thu (cÇn 5 Bét M× + 1 Nh©n B¸nh)",
    ...
    [11] = "Nh©n vËt cÊp 77 trë lªn, ®· vµo m«n ph¸i vµ cã 1 kü n¨ng cÊp 55 míi cã thÓ kÝch ho¹t Hoa §¨ng",
    [12] = "ChØ cã thÓ kÝch ho¹t Hoa §¨ng t¹i c¸c thµnh thÞ lín (BiÖn Kinh, Thµnh §«, TuyÒn Ch©u, D­¬ng Ch©u, T­¬ng D­¬ng, §¹i Lý, Ph­îng T­êng).",
    [13] = "TiÒn vµng ®¹i hiÖp mang theo kh«ng ®ñ.",
    [14] = "§¹i hiÖp ®· sö dông qu¸ nhiÒu b¸nh ®· n­íng chÝn vµ b¸nh ch­a n­íng chÝn råi, kh«ng thÓ tiÕp tôc sö dông.",
    [15] = "§¹i hiÖp ®· sö dông qu¸ nhiÒu b¸nh trung thu kh«ng thÓ tiÕp tôc sö dông.",
    [16] = "RÊt tiÕc, chiÕc lß n­íng nµy kh«ng thuéc vÒ c¸c h¹, c¸c h¹ cÇn sö dông lß n­íng b¸nh cña m×nh.",
    [17] = "Giai ®o¹n nµy cã thÓ bá vµo 1 bã cñi, nh­ vËy míi cã thÓ n­íng ra b¸nh ngon ®­îc.",
    [18] = "Ta bá 1 bã cñi vµo ®©y.",
    [19] = "Ta cÇn ph¶i mua cñi tr­íc ®·",
    [20] = "Cñi trong lß ®ang vÉn cßn, ®îi sau <color=red>%d gi©y<color> h·y bá vµo thªm nhÐ.",
    [21] = "Nh÷ng chiÕc b¸nh trung thu hÊp dÉn ®· ®­îc n­íng xong, h·y nhanh chãng nhËn b¸nh ®i, lß n­íng s¾p biÕn mÊt råi.",
    [22] = "LËp tøc nhËn b¸nh",
    [23] = "T¹m thêi kh«ng nhËn",
    [24] = "PhÇn th­ëng nµy chØ ®­îc nhËn 1 lÇn, ®¹i hiÖp kh«ng thÓ nhËn tiÕp.",
    [25] = "Ho¹t ®éng ®· kÕt thóc, v× vËy cÈm nang ®¹i sù kiÖn còng hÕt hiÖu lùc.",
    [26] = "Ta muèn nhËn phÇn th­ëng sö dông tèi ®a b¸nh Trung Thu",
    [27] = "",
    [28] = "",
};
...
VET_201009_01_LIMITED_AWARD =
{
    ...
    {1, 5, "Hoµng Kim Hång Bao (trèng)", {2,1,538, 1}, 7 * 24 * 3600},
    {1, 10, "Tö Kim Hång Bao (trèng)", {2,1,536, 1}, 7 * 24 * 3600},
    {1, 349, "Nh©n S©m V¹n N¨m", {2,1,30071, 1}, 0},
    {1, 1, "§Þnh Hån Thiªn Th¹ch", {2,1,1067, 1}, 7 * 24 * 3600},
