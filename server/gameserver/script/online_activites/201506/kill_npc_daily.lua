Include("\\script\\online_activites\\201506\\head.lua")
Include("\\script\\online_activites\\201506\\kill_npc_weekly.lua")
NORMAL_TYPE = 1 --ÆÕÍ¨
ADVANCED_TYPE = 2 --¸ß¼¶
...
tbKillNpcDaily.tbLogInfo = {"Ho¹t ®éng phô 06/2015", "Ho¹t ®éng phô 06/2015"}
tbKillNpcDaily.tbAward = 
{
	[NORMAL_TYPE] = 
	{
		...
		tbCost = 
		{
			...
			{2, 1, 30863, 2000, "R­¬ng B¶o §å"},
			{2, 1, 30864, 2000, "Ch×a khãa b¹c"},
		},
		tbPrize = 
		{
			{"Exp", 39000000},
...
{
	szTaskName = "Thu thËp B¶o VËt V¹n Niªn (Ngµy th­êng)",
	...
	szNpcNormalSelection = "Hoµn thµnh nhiÖm vô phæ th«ng (Tiªu hao 2000 R­¬ng B¶o §å + 2000 Ch×a Khãa B¹c + 29 Tiªu Dao Ngäc)",
	szNpcAdvanceSelection = "Hoµn thµnh nhiÖm vô cao cÊp (Tiªu hao 2000 R­¬ng B¶o §å + 2000 Ch×a Khãa B¹c + 299 Tiªu Dao Ngäc)",
...
function tbKillNpcDaily:GivePrize(nSelectType)
	...
	gf_WriteLogEx("Ho¹t ®éng phô 06/2015", "NhanThuongPhoThong",0, "NhanThuongPhoThong");
end
