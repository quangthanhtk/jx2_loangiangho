...
Include("\\script\\online_activites\\201506\\kill_npc_daily.lua")
...
tbKillNpcWeekly.tbLogInfo = {"Ho¹t ®éng Phô 06/2015", "Ho¹t ®éng Phô 06/2015"}
...
{
	szTaskName = "Thu thËp B¶o VËt V¹n Niªn (Cuèi tuÇn)",
	...
	szNpcSelection = "Hoµn thµnh nhiÖm vô BOSS (Tiªu hao 2000 R­¬ng B¶o §å + 2000 Ch×a Khãa B¹c + 299 Tiªu Dao Ngäc)",
...
function tbKillNpcWeekly:GivePrize()
	...
	gf_WriteLogEx("Ho¹t ®éng phô 06/2015", "NhanThuongCaoCap",0, "NhanThuongCaoCap");
end
