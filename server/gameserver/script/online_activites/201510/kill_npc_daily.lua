...
tbKillNpcDaily.tbLogInfo = {"Ho¹t ®éng th¸ng 10", "Ho¹t ®éng th¸ng 10"}
...
{
	szTaskName = "NhiÖm vô thu thËp hµng ngµy",
	...
	szNpcNormalSelection = format("Hoµn thµnh nhiÖm vô th­êng(tiªu hao %d%s + %d%s + %d%s)", 
	...
	szNpcAdvanceSelection = format("Hoµn thµnh nhiÖm vô cao cÊp(tiªu hao %d%s + %d%s + %d%s)", 
