...
tbKillNpcWeekly.tbLogInfo = {"Ho¹t ®éng th¸ng 10", "Ho¹t ®éng th¸ng 10"}
...
{
	szTaskName = "NhiÖm vô thu thËp Hoµng Kim hµng ngµy",
	...
	szNpcSelection = format("Hoµn thµnh nhiÖm vô th­êng(tiªu hao %d%s + %d%s + %d%s)", 
		tbKillNpcWeekly.tbAward.tbCost[1][4], tbKillNpcWeekly.tbAward.tbCost[1][5],
		tbKillNpcWeekly.tbAward.tbCost[2][4], tbKillNpcWeekly.tbAward.tbCost[2][5],
		tbKillNpcWeekly.tbAward.tbCost[3][4], tbKillNpcWeekly.tbAward.tbCost[3][5]),
