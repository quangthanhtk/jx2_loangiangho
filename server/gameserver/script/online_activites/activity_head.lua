...
function ahf_Get70GaojiMiji(bIsByRoute, nNum, bIsBand)
	...
	local tBook = {
		...
		[25] = {0, 107, 199, "Cöu Thiªn Phong L«i QuyÕt"},
		[26] = {0, 107, 200, "Cöu Thiªn Phong L«i QuyÕt"},
		[27] = {0, 107, 201, "Cöu Thiªn Phong L«i QuyÕt"},
		[29] = {0, 107, 202, "Hång TrÇn Tóy Méng Phæ"},
		[30] = {0, 107, 203, "Phong Hoa Thiªn DiÖp Phæ"},
		[31] = {0, 107, 230, "Hång TrÇn Tóy Méng Phæ"},
		[32] = {0, 107, 234, "Phong Hoa Thiªn DiÖp Phæ"},
	}
	local nIndex = 0
...
AH_GG_BOOK1 = {
		...
		[25] = {0, 107, 219, "Cöu Thiªn Phong L«i Ch©n QuyÓn"},
		[26] = {0, 107, 220, "Cöu Thiªn Phong L«i Ch©n QuyÓn"},
		[27] = {0, 107, 221, "Cöu Thiªn Phong L«i Ch©n QuyÓn"},
...
AH_GG_BOOK2 = {
	...
	[8] = {0, 107, 30005, "Nh­ ý Kim §Ønh Ch©n QuyÓn (Cao cÊp)"},
	[9] = {0, 107, 30006, "BÝch H¶i TuyÖt ¢m Ch©n QuyÓn (Cao cÊp)"},
	...
	[25] = {0, 107, 30035, "Cöu Thiªn Phong L«i Ch©n QuyÓn (Cao cÊp)"},
	[26] = {0, 107, 30036, "Cöu Thiªn Phong L«i Ch©n QuyÓn (Cao cÊp)"},
	[27] = {0, 107, 30037, "Cöu Thiªn Phong L«i Ch©n QuyÓn (Cao cÊp)"},
	[29] = {0, 107, 30016, "Hång TrÇn Tóy Méng Ch©n QuyÓn (Cao cÊp)"},
	[30] = {0, 107, 30017, "Phong Hoa Thiªn DiÖp Ch©n QuyÓn (Cao cÊp)"},	
	[31] = {0, 107, 30041, "Mª Tung Ch©n QuyÓn (Cao cÊp)"},
	[32] = {0, 107, 30043, "Thiªn Phong Ch©n QuyÓn (Cao cÊp)"},
}

--¸ß¼¶Õæ¾í
function ahf_GetGaojiZhenjuan(bIsByRoute, nNum, bIsBand, bookIndex)
	if not nNum or nNum <= 0 then
		return
	end
	bIsBand = bIsBand or 4
	...
	local tBook = tGgBook[bookIndex];
	local nIndex = 0
	if bIsByRoute and bIsByRoute == 1 then
		nIndex = GetPlayerRoute();
	else
		local tRoute = {2,3,4,6,8,9,11,12,14,15,17,18,20,21,23,29,30,31,32}
		nIndex = tRoute[random(getn(tRoute))]
	end
	if not tBook[nIndex] then return 0; end
...
VET_YAOYANG_WEAPON = {
		...
		[31] = {{0, 1,	8995, 1, 4, -1, -1, -1, -1, -1, -1}, "DiÖu D­¬ng-V¹n KiÕp Th¸nh Thñ Tr©m"},
		[32] = {{0, 2,	9006, 1, 4, -1, -1, -1, -1, -1, -1}, "DiÖu D­¬ng-BÊt §éng Ch©n Tiªn KiÕm"},		
}
...
VET_ZHANKUANG_CLOTH = {
	...
	[31] = {
			[1] = {{0, 100, 32169, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Bµn V©n Bµo"},
			[2] = {{0, 100, 32169, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Bµn V©n Bµo"},
			[3] = {{0, 100, 32169, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Bµn V©n Bµo"},
			[4] = {{0, 100, 32169, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Bµn V©n Bµo"},
		},
	[32] = {
		[1] = {{0, 100, 32170, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Tr¶m Ma Bµo"},
		[2] = {{0, 100, 32170, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Tr¶m Ma Bµo"},
		[3] = {{0, 100, 32170, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Tr¶m Ma Bµo"},
		[4] = {{0, 100, 32170, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Tr¶m Ma Bµo"},
	},
}
...
VET_ZHANKUANG_CAP = {
	...
	[31] = {
			[1] = {{0, 103, 32169, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Bµn V©n Qu¸n"},
			[2] = {{0, 103, 32169, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Bµn V©n Qu¸n"},
			[3] = {{0, 103, 32169, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Bµn V©n Qu¸n"},
			[4] = {{0, 103, 32169, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Bµn V©n Qu¸n"},
		},
		[32] = {
			[1] = {{0, 103, 32170, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Tr¶m Ma Qu¸n"},
			[2] = {{0, 103, 32170, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Tr¶m Ma Qu¸n"},
			[3] = {{0, 103, 32170, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Tr¶m Ma Qu¸n"},
			[4] = {{0, 103, 32170, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Tr¶m Ma Qu¸n"},
		},
}  
...
VET_ZHANKUANG_SHOE = {
	...
	[31] = {
			[1] = {{0, 101, 32169, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Bµn V©n Trang"},
			[2] = {{0, 101, 32169, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Bµn V©n Trang"},
			[3] = {{0, 101, 32169, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Bµn V©n Trang"},
			[4] = {{0, 101, 32169, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Bµn V©n Trang"},
		},
		[32] = {
			[1] = {{0, 101, 32170, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Tr¶m Ma Trang"},
			[2] = {{0, 101, 32170, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Tr¶m Ma Trang"},
			[3] = {{0, 101, 32170, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Tr¶m Ma Trang"},
			[4] = {{0, 101, 32170, 1, 4, -1, -1, -1, -1, -1, -1}, "ChiÕn Cuång Tr¶m Ma Trang"},
		},
}
...
VET_ZHANKUANG_WEAPON = {
	...
	[30] = {
	  ...
	  [31] = {
	  [1]={{0,14,32217,1,4,-1,-1,-1,-1,-1,-1}, "ChiÕn Cuång Bµn V©n Chñy",1,31},
	  [2]={{0,14,32217,1,4,-1,-1,-1,-1,-1,-1}, "ChiÕn Cuång Bµn V©n Chñy",2,31},
	  [3]={{0,14,32217,1,4,-1,-1,-1,-1,-1,-1}, "ChiÕn Cuång Bµn V©n Chñy",3,31},
	  [4]={{0,14,32217,1,4,-1,-1,-1,-1,-1,-1}, "ChiÕn Cuång Bµn V©n Chñy",4,31},
	  },
		[32] = {
      [1]={{0,2,32218,1,4,-1,-1,-1,-1,-1,-1}, "ChiÕn Cuång Tr¶m Ma KiÕm",1,32},
      [2]={{0,2,32218,1,4,-1,-1,-1,-1,-1,-1}, "ChiÕn Cuång Tr¶m Ma KiÕm",2,32},
      [3]={{0,2,32218,1,4,-1,-1,-1,-1,-1,-1}, "ChiÕn Cuång Tr¶m Ma KiÕm",3,32},
      [4]={{0,2,32218,1,4,-1,-1,-1,-1,-1,-1}, "ChiÕn Cuång Tr¶m Ma KiÕm",4,32},
	  },
}
...
function ahf_GiveYunLingLevel5()
	local szMsgTitle = "UÈn Linh CÊp 5"
	--tPara = {nCount, nBind, nExpireDays, bGblMsg}
	local tbParamData = {1, 4, 7, nil}
	_MA_GiveRandItem(VET_YUNLING_LEVEL_5, tbParamData, szMsgTitle, 1)
end
...
function ahf_GiveYunLingLevel6()
	local szMsgTitle = "UÈn Linh CÊp 6"
	--tPara = {nCount, nBind, nExpireDays, bGblMsg}
	local tbParamData = {1, 4, 7, nil}
	_MA_GiveRandItem(VET_YUNLING_LEVEL_6, tbParamData, szMsgTitle, 1)
end
