...
VET_GOLD_BOX_AWARD = {
 	...
 	{1, 39, "Qu©n C«ng Huy Hoµng", {2, 1, 9977, 1}, 7 * 24 * 3600},
 	{1, 52, "Th¸i DÞch Hçn Nguyªn Phæ", {2, 0, 1083, 1}, 0},
	{1, 200, "L¨ng Ba Vi Bé", {0, 112, 78, 1, 1}, 0},
	{31, 570, "Book_Pet3()", ""},
     {1, 39, "B¹ch Kim R­¬ng", {2, 1, 30343, 1}, 0},
     {1, 200, "ChuyÓn Sinh §¬n", {2, 1, 30345, 1}, 30 * 24 * 3600},
}
VET_BOOK_PET3 = {
...
function Book_Pet3()
	gf_EventGiveRandAward(VET_BOOK_PET3,10000,"", "Than Tai Bao Ruong","Sö dông Kim R­¬ng")
end