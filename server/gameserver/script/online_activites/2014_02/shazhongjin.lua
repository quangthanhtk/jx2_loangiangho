...
VET_201402_ACTIVITYID = 150;

VET_201402_MAIN = "Sa Trung Kim /Vet_201402_main";

VET_201402_TASK = TaskManager:Create(6, 14)
...
VET_201402_TASK.KILL4 = 7;
VET_201402_TASK.KILL5 = 8;
...
function Vet_201402_AcceptTask()
	...
	if nStep ~= 0 then
		...
		elseif nStep == 3 then
			Msg2Player("tiªu diÖt 690 Sa M¹c Hµnh Nh©n, tiªu diÖt 690 TÇm B¶o Nh©n");
		elseif nStep == 4 then
	...
	Msg2Player("§Õn Mª Cung Sa M¹c t×m B¹ch Thiªn Thµnh");
	TaskTip("§Õn Mª Cung Sa M¹c t×m B¹ch Thiªn Thµnh");
end
...
function Vet_201402_KillNpc1(szName)
	...
	if szName == "Sa M¹c Hµnh Nh©n" and VET_201402_TASK:GetTask(VET_201402_TASK.KILL1) < 690 then
		VET_201402_TASK:SetTask(VET_201402_TASK.KILL1, VET_201402_TASK:GetTask(VET_201402_TASK.KILL1) + 1);
		Msg2Player(format("Tiªu diÖt Sa M¹c Hµnh Nh©n %d/690", VET_201402_TASK:GetTask(VET_201402_TASK.KILL1)));
	elseif szName == "TÇm B¶o Nh©n" and VET_201402_TASK:GetTask(VET_201402_TASK.KILL2) < 690 then
		VET_201402_TASK:SetTask(VET_201402_TASK.KILL2, VET_201402_TASK:GetTask(VET_201402_TASK.KILL2) + 1);
		Msg2Player(format("Tiªu diÖt TÇm B¶o Nh©n %d/690", VET_201402_TASK:GetTask(VET_201402_TASK.KILL2)));
	end
	if VET_201402_TASK:GetTask(VET_201402_TASK.KILL1) >= 690 and VET_201402_TASK:GetTask(VET_201402_TASK.KILL2) >= 690 then
		Talk(1,"","§Õn Quang Minh §Ønh t×m ¢n Minh(211/184)");
		TaskTip("§Õn Quang Minh §Ønh t×m ¢n Minh(211/184)");
...
function Vet_201402_KillNpc2(szName)
	...
	Vet_201402_KillNpc3(szName);
	
	if VET_201402_TASK:GetTask(VET_201402_TASK.TASK) ~= 6 then
		return 0;
	end
	if szName == "§Ö Tö Minh gi¸o" and VET_201402_TASK:GetTask(VET_201402_TASK.KILL3) < 399 then
		VET_201402_TASK:SetTask(VET_201402_TASK.KILL3, VET_201402_TASK:GetTask(VET_201402_TASK.KILL3) + 1);
		Msg2Player(format("Tiªu diÖt §Ö Tö Minh Gi¸o %d/399", VET_201402_TASK:GetTask(VET_201402_TASK.KILL3)));
	elseif szName == "Gian TÕ Minh gi¸o" and VET_201402_TASK:GetTask(VET_201402_TASK.KILL4) < 399 then
		VET_201402_TASK:SetTask(VET_201402_TASK.KILL4, VET_201402_TASK:GetTask(VET_201402_TASK.KILL4) + 1);
		Msg2Player(format("Tiªu diÖt Gian TÕ Minh Gi¸o %d/399", VET_201402_TASK:GetTask(VET_201402_TASK.KILL4)));
	end
	if VET_201402_TASK:GetTask(VET_201402_TASK.KILL3) >= 399 and VET_201402_TASK:GetTask(VET_201402_TASK.KILL4) >= 399 then
		Talk(1,"","Quay VÒ T×m ¢n Minh");
		TaskTip("Quay VÒ T×m ¢n Minh");
		VET_201402_TASK:SetTask(VET_201402_TASK.TASK, 3);
	end
end

function Vet_201402_KillNpc3(szName)
	if gf_CheckEventDateEx(VET_201402_ACTIVITYID) ~= 1 then
		return 0;
	end
	...
	if szName == "HuyÕt C« L©u" and VET_201402_TASK:GetTask(VET_201402_TASK.KILL5) >= 399 then
		Talk(1,"","Quay VÒ T×m §Ö Tö C«n L«n");
		TaskTip("Quay VÒ T×m §Ö Tö C«n L«n");
	end
end