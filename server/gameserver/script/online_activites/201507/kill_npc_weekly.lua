...
Include("\\script\\online_activites\\201507\\kill_npc_daily.lua")
...
tbKillNpcWeekly.tbTaskGroupId = {1, 23}
...
tbKillNpcWeekly.tbLogInfo = {"Ho¹t ®éng 07/2015", "Ho¹t ®éng 07/2015"}
...
{
	szTaskName = "Thu thËp Kim Bµi Tinh Qu©n (Cuèi tuÇn)",
	...
	szNpcSelection = "Hoµn thµnh nhiÖm vô BOSS (Tiªu hao 2000 LÖnh Bµi + 2000 Qu©n Phôc + 299 Tiªu Dao Ngäc)",
...
function tbKillNpcWeekly:GivePrize()
	...
	gf_WriteLogEx("Ho¹t ®éng phô 07/2015", "NhanThuongCaoCap",0, "NhanThuongCaoCap");
end
