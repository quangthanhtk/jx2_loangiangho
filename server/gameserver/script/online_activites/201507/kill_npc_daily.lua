Include("\\script\\online_activites\\201507\\head.lua")
Include("\\script\\online_activites\\201507\\kill_npc_weekly.lua")
NORMAL_TYPE = 1 --ÆÕÍ¨
ADVANCED_TYPE = 2 --¸ß¼¶
...
tbKillNpcDaily.tbTaskGroupId = {1, 23}
...
tbKillNpcDaily.tbLogInfo = {"Ho¹t ®éng 07/2015", "Ho¹t ®éng 07/2015"}
...
{
	szTaskName = "Thu thËp Kim Bµi Tinh Qu©n (Ngµy th­êng)",
	...
	szNpcNormalSelection = "Hoµn thµnh nhiÖm vô phæ th«ng (Tiªu hao 2000 LÖnh Bµi + 2000 Qu©n Phôc + 29 Tiªu Dao Ngäc)",
	szNpcAdvanceSelection = "Hoµn thµnh nhiÖm vô cao cÊp (Tiªu hao 2000 LÖnh Bµi + 2000 Qu©n Phôc + 299 Tiªu Dao Ngäc)",
...
function tbKillNpcDaily:GivePrize(nSelectType)
	...
	gf_WriteLogEx("Ho¹t ®éng phô 07/2015", "NhanThuongPhoThong",0, "NhanThuongPhoThong");
end
