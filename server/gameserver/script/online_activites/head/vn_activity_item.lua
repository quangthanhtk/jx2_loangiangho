...
function OnUse(nItemIndex)
	if gf_CheckEventDateEx(166) ~= 1 then
...
--			if GetTask(2764) < 1 or GetTask(2765) < 1 or GetTask(2769) < 1 then
--				Talk(1,"","§¹i hiÖp ch­a nhËn phÇn th­ëng cuèi mèc 2000 nªn kh«ng thÓ sö dông tiÕp vËt phÈm event !!!!")
--				return 0
--			end
--			tbActivity:ItemPrizeOnUse(nItemIndex,nItemSeq)
			-- if GetTask(2766) == 4000 and GetTask(2767) == 4000 and GetTask(2768) == 4000 and nCheckMaxEvent == 0 then
