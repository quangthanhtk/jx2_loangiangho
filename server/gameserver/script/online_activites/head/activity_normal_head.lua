...
EVENT_LOG_TITLE = "Hoat dong thang 10/2015"
...
--				tinsert(tbSayDialog,gf_VnGetChangeSaySel(self.sActivityChgKey.."Chg"..tostring(i)).."/#VNG_DoiEvent_Form1(\""..self.sActivityChgKey.."Chg"..tostring(i).."\")")
			elseif i == 2 then
				tinsert(tbSayDialog,"§æi N­íc Hoa Th­êng vµ N­íc Hoa Kh« (cÇn 10 X¹ H­¬ng vµ 10 Tói Th¬m + 2 Tiªu Dao Ngäc)/VNG_DoiEvent_Form2")
				tinsert(tbSayDialog,"§æi N­íc Hoa Nång Nµn (cÇn 1 N­íc Hoa Th­êng + 20 Tói th¬m ®Æc biÖt)/#VNG_DoiEvent_Form3(1)")
				tinsert(tbSayDialog,"§æi N­íc Hoa Nång Nµn (cÇn 1 N­íc Hoa Kh« + 20 Tói th¬m ®Æc biÖt)/#VNG_DoiEvent_Form3(2)")
			end
		end
...
VAF_AWARD_API_TABLE = {
	...
	["tSilingJinBox"] = "R­¬ng Vµng ThÝ LuyÖn Tø Linh",
	["tSilingYinBox"] = "R­¬ng B¹c ThÝ LuyÖn Tø Linh",
	["tSilingTongBox"] = "R­¬ng §ång ThÝ LuyÖn Tø Linh",
	["tWorldBossJinBox"] = "R­¬ng Vµng §¹i ChiÕn",
	["tWorldBossBox"] = "§¹i ChiÕn B¶o H¹p",
	["tLiangShanFinish"] = "Th«ng quan L­¬ng S¬n B¹c",
	["tWanJianZongFinish"] = "Th«ng quan  V¹n KiÕm Tròng",
	["tDiXuanGongFinish"] = "Th«ng quan §Þa HuyÒn Cung",
	["tTaiXuFinish"] = "Th«ng quan Th¸i H­ HuyÔn C¶nh",
	["tTYTFinish"] = "Th«ng quan Th¸i NhÊt Th¸p phæ th«ng",
	["tTYTFinish_H"] = "Th«ng quan Th¸i NhÊt Th¸p anh hïng",
