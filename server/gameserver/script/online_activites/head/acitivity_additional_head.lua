...
function Ud_GiveAward_139_2()
	...
	local tAward = {
		...
		{32, 15, 1000, 1},
		{33, 5, 1000, 1},
		{1, 10, "Cöu ChuyÓn Hoµn Hån §an", {1, 0, 32, 2}, 0},
...
function Ud_GiveAward_143_1()
	gf_Modify("Exp", 6900000);
	AwardGenuineQi(30);
	gf_EventGiveCustomAward(3, 20, 1, "Ho¹t ®éng phô 12/2014");
	gf_EventGiveCustomAward(4, 20, 1, "Ho¹t ®éng phô 12/2014");
end
...
function Ud_GiveLastAward_201412()
	AwardGenuineQi(1000)
	gf_EventGiveCustomAward(3, 350, 1, "Ho¹t ®éng phô 12/2014");
	gf_EventGiveCustomAward(4, 350, 1, "Ho¹t ®éng phô 12/2014");
	gf_AddItemEx2({2, 1, 9977, 3, 4}, "Qu©n C«ng Huy Hoµng", "Ho¹t ®éng phô 12/2014", "Ho¹t ®éng phô 12/2014", 7 * 24 * 3600, 1)
end