...
tbKillNpcDaily.tbAward = 
{
	[NORMAL_TYPE] = 
	{
		...
		tbCost = 
		{
			...
			{2, 1, 30887, 3000, "Hoa sen"},
			{2, 1, 30888, 3000, "GiÊy Gãi Hoa"},
		},
		tbPrize = 
		{
			{"Exp", 100000000},
...
tbKillNpcDaily.tbLang = 
{
	...
	szNpcNormalSelection = "Hoµn thµnh nhiÖm vô phæ th«ng (Tiªu hao 3000 Hoa Sen + 3000 GiÊy Gãi Hoa + 75 Tiªu Dao Ngäc)",
	szNpcAdvanceSelection = "Hoµn thµnh nhiÖm vô cao cÊp (Tiªu hao 3000 Hoa Sen + 3000 GiÊy Gãi Hoa + 223 Tiªu Dao Ngäc)",
