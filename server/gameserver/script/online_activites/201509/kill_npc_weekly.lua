...
{
	szTaskName = "Thu tËp b¸nh ®Æc biÖt (ngµy vµng)",
	...
	szNpcSelection = "Hoµn thµnh nhiÖm vô BOSS (tiªu hao 3000 bét m× + 3000 nh©n b¸nh + 223 tiªu dao ngäc)",
