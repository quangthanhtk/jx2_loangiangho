Include("\\script\\online_activites\\201509\\head.lua")
Include("\\script\\online_activites\\201509\\kill_npc_weekly.lua")
NORMAL_TYPE = 1 --ÆÕÍ¨
ADVANCED_TYPE = 2 --¸ß¼¶
...
{
	szTaskName = "Thu tËp b¸nh ®Æc biÖt (ngµy th­êng)",
	...
	szNpcNormalSelection = "Hoµn thµnh nhiÖm vô phæ th«ng (tiªu hao 3000 bét m× + 3000 nh©n b¸nh + 75 tiªu dao ngäc)",
	szNpcAdvanceSelection = "Hoµn thµnh nhiÖm vô cao cÊp (tiªu hao 3000 bét m× + 3000 nh©n b¸nh + 223 tiªu dao ngäc)",
