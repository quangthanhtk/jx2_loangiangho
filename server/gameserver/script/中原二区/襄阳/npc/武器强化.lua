...
Include("\\script\\item\\item_yuntiejingshi.lua")
...
function main()
	...
	Say("<color=green>Thî rÌn L­u<color>: Nghe nãi trong thiªn h¹ cã mét lo¹i kú th¹ch cã thÓ lµm thay ®æi thuéc tİnh trang bŞ. NÕu ng­¬i t×m ®­îc ta cã thÓ gióp ng­¬i t¨ng cÊp trang bŞ. <color=red>B©y giê ng­¬i cã thÓ söa ngo¹i trang råi!<color>",
		9,
		"NhiÖm vô M¶nh Thiªn Th¹ch thÊt l¹c/get_ManhThienThach", --LongDaiKa: ®ãng tİnh n¨ng
		"T¨ng cÊp trang bŞ/qianghua",
		"Söa ®Æc biÖt/xiuli",
		"§æi N÷ Oa Tinh Th¹ch (cÇn 1 N÷ Oa Tinh Th¹ch (khãa) vµ 1 Cµn Kh«n Phï)/change_nott",
		"Ta muèn nhËn 10 Phi Yªn Th¹ch (tiªu hao 1 trang bŞ Tµng KiÕm + 1 N÷ oa tinh th¹ch + 1 Hoµng kim hång bao)/#get_PhiYen(1)",
		"Ta muèn nhËn 19 Phi Yªn Th¹ch (tiªu hao 1 trang bŞ Thiªn Chi Tµng KiÕm + 1 N÷ oa tinh th¹ch + 1 Hoµng kim hång bao)/#get_PhiYen(2)",
		"Ta muèn nhËn 7 Phi Yªn Th¹ch (tiªu hao 1 vò khİ Bé Phi Yªn + 1 N÷ oa tinh th¹ch)/#get_PhiYen(3)",
...
function get_PhiYen(nSelected)
	...
	if nCheck < 1 then
     ...
     if DelItem(2, 1, 504, tCheck[nSelected][2]) == 1 and DelItem(2, 1, 539, tCheck[nSelected][3]) == 1 then
		...
		Msg2Player("B¹n nhËn ®­îc "..tCheck[nSelected][1].." Phi Yªn Th¹ch")    		
     end
