...
function main()
	local strtab = {
		...
		--"N©ng cÊp Thiªn H¹ V« Song thµnh V« Song ChiÕn ThÇn/THVS_VSCT", --LongDaiKa: ®ãng tİnh n¨ng
		--"N©ng cÊp V« Song ChiÕn ThÇn thµnh H¾c B¹ch V« Song/upgradeVSCT", --LongDaiKa: ®ãng tİnh n¨ng
		"ChÕ t¹o vµ n©ng cÊp trang bŞ/npc_upgrade_talk",
		--"Viªm §Õ/ViemDeMenu", --LongDaiKa: ®ãng tİnh n¨ng
		--"T­íng Qu©n/TuongQuanMenu", --LongDaiKa: ®ãng tİnh n¨ng
		--"Nguyªn So¸i/NguyenSoaiMenu", --LongDaiKa: ®ãng tİnh n¨ng
	...
	--
	--tinsert(strtab,1,"N©ng cÊp nhÉn V« Cùc Tinh Minh/VoCucTinhMinh_Menu") --LongDaiKa: ®ãng tİnh n¨ng
	--tinsert(strtab,1,"N©ng cÊp nhËn Hµo HiÖp V« H¹/HaoHiepVoHa_Menu") --LongDaiKa: ®ãng tİnh n¨ng
	--tinsert(strtab,1,"ChuyÓn ®æi trang bŞ Uy Hæ T­íng Qu©n/DoiPhe_UyHoTuongQuan_Menu") --LongDaiKa: ®ãng tİnh n¨ng
	--tinsert(strtab,1,"ChuyÓn ®æi trang bŞ Uy Hæ Nguyªn So¸i/DoiPhe_UyHoNguyenSoai_Menu") --LongDaiKa: ®ãng tİnh n¨ng
