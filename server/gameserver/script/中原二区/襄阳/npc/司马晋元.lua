...
function main()
	--dofile("script/ÖÐÔ­¶þÇø/ÏåÑô/npc/Ë¾Âí½úÔª.lua");
	if g_WCFG_NEWRESOURCE:IsDateOpen(1) ~= WEnv.TRUE then
...
--		"Khëi ®éng chiÕn tr­êng/open_newres",
	...
	Say(szNpcName.."T­ M· gia kh«ng cã tiÕng t¨m trªn giang hå lµ v× b¶o thñ, kh«ng biÕt n¾m b¾t thêi c¬ chñ ®éng xuÊt kÝch. Tõ nay ta sÏ lµm thay ®æi t×nh h×nh nµy. Nghe nãi hai n­íc Tèng Liªu ®ang giao tranh cÇn rÊt nhiÒu tµi nguyªn. T­ M· ta më chiÕn dÞch khai th¸c tµi nguyªn chiÕn cho c¶ hai phe. Ng­¬i muèn tham gia kh«ng?",getn(tSay),tSay)
end