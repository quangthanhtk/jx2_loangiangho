...
tTalk = {
	check = function(tTalk) end,	-- ¼ì²é Èç¹û·µ»ØnilÔòÖ±½ÓÍË³ö
	commonSel = 0,					-- Ã¿Ò³¶¼ÓĞµÄÑ¡Ïî(´ÓºóÃæÊın¸ö)
	sel = {},						-- Ñ¡Ïî
	makeSure = nil,					-- È·ÈÏ (Ä¬ÈÏÑ¡ÏîºÍ×îºóÒ»¸öÑ¡Ïî²»ĞèÒªÈ·ÈÏ)
}
...
function makeSure(self, nSel, cb)
	...
	if not self then return end
	suSay(self.msg.."\n".."§¹i hiÖp chän lµ <color=gold>"..self.sel[nSel][1].."<color>\n ®¹i hiÖp x¸c ®Şnh chø?",
		2,
		"§óng vËy/"..cb,
		"Ta suy nghÜ thªm mét l¸t/nothing");
end
