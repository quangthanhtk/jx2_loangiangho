...
function know_super_account()
	Talk(2,"RequestSuperAccountAward","<color=yellow>Tõ 15/04-15/07<color>, ng­êi ch¬i cã thÓ tham gia nhiÒu ho¹t ®éng ®Ó nhËn phÇn th­ëng Siªu b¹ch kim. Tõ <color=yellow>15/04-15/07<color> tham gia nhiÒu ho¹t ®éng ®Ó nhËn phÇn th­ëng gi¸ trÞ. Th«ng tin chi tiÕt ho¹t ®éng ®ång ®¹o cã thÓ xem t¹i trang chñ.","Khi ®¹t ®Õn cÊp 40 vµ 70 nhí ®Õn chç ta ®Ó nhËn phÇn th­ëng t¨ng cÊp. Mçi 1 tµi kho¶n chØ nhËn phÇn th­ëng 1 lÇn. Chóc ch¬i vui vÎ!");
end;
...
{			--ÎïÆ·Ãû		ËùÐè»ý·Ö  ÓÐÐ§Ê±¼ä
	...
	[3] =  {"Cöu ChuyÓn Hoµn Hån §an",		3,30*24*3600,	{1,0,32}},
...
function is_super_account()
	...
	if (cChar1 == "K" or cChar1 == "k") and (cChar2 == "S" or cChar2 == "s") then
		if ((cChar3 == "Q" or cChar3 == "q") and (cChar4 == "D" or cChar4 == "d")) or --ksqd
			((cChar3 == "J" or cChar3 == "j") and (cChar4 == "X" or cChar4 == "x")) or --ksjx
			((cChar3 == "W" or cChar3 == "w") and (cChar4 == "Z" or cChar4 == "z")) or -- kswz
			((cChar3 == "G" or cChar3 == "g") and (cChar4 == "W" or cChar4 == "w")) then -- ksgw
				--return 1;
				return 0;
		else
			return 0;
