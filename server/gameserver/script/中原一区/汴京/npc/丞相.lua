...
tb_introduce_rank = {
	[1] = {"Tiªn Phong", BYTE_TIENPHONG, 3, 2, 1, 1, 80000, 4},
	[2] = {"T­íng Qu©n", BYTE_TUONGQUAN, 7, 3, 1, 3, 120000, 5},
}
...
function introduce_rank()
	...
	Say(g_szInfoHeader.."<color=yellow>Nguyªn So¸i<color> cã thÓ tiÕn cö <color=yellow>3 Tiªn Phong<color> vµ <color=yellow>7 T­íng Qu©n<color> cïng phe, <color=yellow>T­íng Qu©n<color> cã thÓ tiÕn cö 2 Tiªn Phong cïng phe. Tiªn Phong tiÕn cö <color=yellow>cÇn 300.000 ®iÓm qu©n c«ng vµ 1 Hoµng Kim §¹i Hång Bao <color>. T­íng Qu©n tiÕn cö <color=yellow>cÇn 900.000 ®iÓm qu©n c«ng vµ 3 Hoµng Kim §¹i Hång Bao<color>. <color=red>Chó ý: qu©n hµm tiÕn cö chØ cã hiÖu lùc trong tuÇn. §Õn 21 giê thø 7 h»ng tuÇn sÏ xÐt l¹i qu©n hµm.<color>",getn(tSay),tSay);
end
...
function offer_rank(nType,nCurCamp)
	...
	if nHour < 0800 then
		Talk ( 1, "", g_szInfoHeader.."HiÖn t¹i thêi gian vÉn cßn sím, nÕu muèn tiÕn cö th× ng­¬i h·y quay l¹i sau 8 giê s¸ng !!!!" )
		return 0
	end
...
--				
				...
				if DelItem(2,1,539,tb_introduce_rank[nType][6]) == 1 then --DelItem(2,1,504,tb_introduce_rank[nType][4]) == 1 then	--and DelItem(2,1,537,tb_introduce_rank[nType][5]) == 1 and DelItem(2,1,539,tb_introduce_rank[nType][6]) == 1
