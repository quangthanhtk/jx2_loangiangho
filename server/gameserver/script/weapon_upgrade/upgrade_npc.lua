...
THVS_VSCT_FILE = "\\script\\vng\\weapon_upgrade\\thvstovscti.lua";
...
TRANGSUC_DIEUDUONG_2TO3_FILE = "\\script\\vng\\weapon_upgrade\\dieuduong_trangsuc3.lua";
...
function NguyenSoaiMenu()
	local tbSay = {
		...
		"Ngù Long - Chiªu Th¸nh Nguyªn So¸i thµnh §¹i Tèng-Liªu Nguyªn So¸i (100%)/upgrade_upper_mar_100",
...
function RenLaiVuKhi_Form()
	...
	szSay = szSay .. "+ N©ng cÊp Vò khÝ 76 (+7)  thµnh  vò khÝ 86 (+7): tiªu hao 1 vò khÝ 76 (+7) trë lªn, 3 N÷ Oa Tinh Th¹ch, 1 Cöu Thiªn V« Cùc §¬n\n"
	szSay = szSay .. "+ N©ng cÊp Vò khÝ 86 (+10)  thµnh  vò khÝ 96 (+7): tiªu hao 1 vò khÝ 86 (+10) trë lªn, 6 N÷ Oa Tinh Th¹ch, 2 Cöu Thiªn V« Cùc §¬n\n"
...
function NguLong2ThuongUngTuongQuan100Upgrade_Form()
	...
	szSay = szSay .. "* Nãn, gi¸p, quÇn: Trang bÞ c­êng hãa 7 trë lªn, 1 Cöu Thiªn V« Cùc §¬n, 1 N÷ Oa Tinh Th¹ch\n"
	szSay = szSay .. "* LÖnh, kú, phï: 1 Cöu Thiªn V« Cùc §¬n, 1 N÷ Oa Tinh Th¹ch.\n"
	szSay = szSay .. "<color=red>Tû lÖ thµnh c«ng 100%<color>"
	tbSay = {
...
function TuongQuan2ThuongUngTuongQuan_Form()
	...
	szSay = szSay .. "* Nãn, gi¸p, quÇn: Trang bÞ T­íng Qu©n c­êng hãa 7 trë lªn, 3 Cöu Thiªn V« Cùc §¬n, 2 N÷ Oa Tinh Th¹ch\n"
	szSay = szSay .. "* LÖnh, kú, phï: 3 Cöu Thiªn V« Cùc §¬n, 2 N÷ Oa Tinh Th¹ch\n"
	szSay = szSay .. "<color=red>Tû lÖ thµnh c«ng 100%<color>"
	tbSay = {
...
function ThienChi2ThuongUngTuongQuan_Form()
	...
	szSay = szSay .. "* Nãn, gi¸p, quÇn: Trang bÞ T­íng Qu©n c­êng hãa 7 trë lªn, 2 Cöu Thiªn V« Cùc §¬n, 2 N÷ Oa Tinh Th¹ch\n"
	szSay = szSay .. "* LÖnh, kú, phï: 2 Cöu Thiªn V« Cùc §¬n, 2 N÷ Oa Tinh Th¹ch\n"
	szSay = szSay .. "<color=red>Tû lÖ thµnh c«ng 100%<color>"
	tbSay = {
...
--	if nDate >= 20150508 and nDate <= 20150511 then
...
function TrangSucDieuDuong3_Menu()
	local tbSay = {}
	local szSayHead = "<color=green>§Ö tö thî rÌn L­u<color>: Ta cã thÓ gióp ®¹i hiÖp n©ng cÊp trang søc DiÖu D­¬ng cÊp 2 lªn trang søc DiÖu D­¬ng cÊp 3."
	tinsert(tbSay, "X¸c nhËn n©ng cÊp/TrangSucDieuDuong_2To3_Menu")
	tinsert(tbSay, "Ta chØ ghÐ xem/gf_DoNothing")
	Say(szSayHead,getn(tbSay),tbSay)
end
function TrangSucDieuDuong_2To3_Menu()
	PutinItemBox("N©ng cÊp trang bÞ" ,1 , "Trang søc DiÖu D­¬ng muèn thùc hiÖn n©ng cÊp?", TRANGSUC_DIEUDUONG_2TO3_FILE, 1)
end
...
function VoCucTinhMinh_Menu()
	local tbSay = {}
	local szSay = "N©ng cÊp thµnh trang bÞ <color=yellow>V« Cùc Tinh Minh<color>, c¸c h¹ cÇn ph¶i cã c¸c nguyªn liÖu sau: \n"
	szSay = szSay.."* 1   [Thiªn §Þa Giíi] hoÆc [NhËt NguyÖt Giíi] \n"
	szSay = szSay.."* 20  [Thiªn M«n Kim LÖnh] \n"
	szSay = szSay.."* 20  [Thiªn Cang LÖnh] \n"
	szSay = szSay.."* 3   [Linh KhÝ Rùc Rì] \n"
	szSay = szSay.."* 4   [Cöu Thiªn V« Cùc §¬n]"
	tinsert(tbSay, "N©ng cÊp tõ Thiªn §Þa Giíi thµnh V« Cùc Giíi/#VoCucTinhMinh_VoHaHaoHiep_upgrade(1)");
	tinsert(tbSay, "N©ng cÊp tõ NhËt NguyÖt Giíi thµnh Tinh Minh Giíi/#VoCucTinhMinh_VoHaHaoHiep_upgrade(2)");
	tinsert(tbSay, "Ta chØ ghÐ xem/gf_DoNothing")
	Say(g_szNpcName..szSay,getn(tbSay),tbSay)
end

function HaoHiepVoHa_Menu()
	do return 0 end
	
	local tbSay = {}
	local szSay = "N©ng cÊp thµnh trang bÞ <color=yellow>V« H¹ Hµo HiÖp<color>, c¸c h¹ cÇn ph¶i cã c¸c nguyªn liÖu sau: \n"
	szSay = szSay.."* 1   [Hµo HiÖp Giíi] hoÆc [Hµo HiÖp Béi] \n"
	szSay = szSay.."* 20  [Thiªn M«n Kim LÖnh] \n"
	szSay = szSay.."* 20  [Thiªn Cang LÖnh] \n"
	szSay = szSay.."* 1   [Linh KhÝ Rùc Rì] \n"
	szSay = szSay.."* 4   [Cöu Thiªn V« Cùc §¬n]"
	tinsert(tbSay, "N©ng cÊp tõ Hµo HiÖp Giíi thµnh LÖnh Bµi V« H¹ Hµo HiÖp (Trang Søc)/#VoCucTinhMinh_VoHaHaoHiep_upgrade(3)");
	tinsert(tbSay, "N©ng cÊp tõ Hµo HiÖp Béi thµnh LÖnh Bµi V« H¹ Hµo HiÖp (Trang Søc)/#VoCucTinhMinh_VoHaHaoHiep_upgrade(4)");
	tinsert(tbSay, "Ta chØ ghÐ xem/gf_DoNothing")
	Say(g_szNpcName..szSay,getn(tbSay),tbSay)
end

function VoCucTinhMinh_VoHaHaoHiep_upgrade(nType)
	local tNguyenLieu = {--sè l­îng: Thiªn M«n Kim LÖnh, Thiªn Cang LÖnh, Linh KhÝ rùc rì, Cöu Thiªn V« Cùc
							[1] = {20, 20, 3, 4, {0, 102, 30037}, {0, 102, 31130}, "Thiªn §Þa Giíi"},
							[2] = {20, 20, 3, 4, {0, 102, 30038}, {0, 102, 31131}, "NhËt NguyÖt Giíi"},
							[3] = {20, 20, 1, 4, {0, 102, 31126}, {2, 1, 30974}, "Hµo HiÖp Giíi"},
							[4] = {20, 20, 1, 4, {0, 102, 31127}, {2, 1, 30974}, "Hµo HiÖp Béi"},
					}
	
	if gf_JudgeRoomWeight(3,200,g_szNpcName) == 0 then
		return 0;
	end
	if GetItemCount(2,1,30370) < tNguyenLieu[nType][1] then	--check Thiªn M«n Kim LÖnh
		Talk(1, "", "§¹i hiÖp ch­a chuÈn bÞ ®ñ "..tNguyenLieu[nType][1].." Thiªn M«n Kim LÖnh.")
		return 0
	end
	if GetItemCount(2,95,204) < tNguyenLieu[nType][2] then	--check Thiªn Cang LÖnh
		Talk(1, "", "§¹i hiÖp ch­a chuÈn bÞ ®ñ "..tNguyenLieu[nType][2].." Thiªn Cang LÖnh.")
		return 0
	end
	if GetItemCount(2,1,31122) < tNguyenLieu[nType][3] then	--check Linh KhÝ Rùc Rì
		Talk(1, "", "§¹i hiÖp ch­a chuÈn bÞ ®ñ "..tNguyenLieu[nType][3].." Linh KhÝ Rùc Rì.")
		return 0
	end
	if GetItemCount(2,1,1006) < tNguyenLieu[nType][4] then	--check Cöu Thiªn V« Cùc
		Talk(1, "", "§¹i hiÖp ch­a chuÈn bÞ ®ñ "..tNguyenLieu[nType][4].." Cöu Thiªn V« Cùc §¬n.")
		return 0
	end
	if GetItemCount(tNguyenLieu[nType][5][1],tNguyenLieu[nType][5][2],tNguyenLieu[nType][5][3]) < 1 then	--check trang bÞ
		Talk(1, "", "§¹i hiÖp kh«ng cã mang theo "..tNguyenLieu[nType][7].." ®Ó n©ng cÊp.")
		return 0
	end
	local nCheck = 0
	if DelItem(2,1,30370,tNguyenLieu[nType][1]) == 1 and DelItem(2,95,204,tNguyenLieu[nType][2]) == 1 and DelItem(2,1,31122,tNguyenLieu[nType][3]) == 1 and DelItem(2,1,1006,tNguyenLieu[nType][4]) == 1 and DelItem(tNguyenLieu[nType][5][1],tNguyenLieu[nType][5][2],tNguyenLieu[nType][5][3],1) == 1 then
		nCheck = 1
	end	
	if nCheck == 1 then
		if nType == 1 or nType == 2 then
			gf_AddItemEx2({tNguyenLieu[nType][6][1],tNguyenLieu[nType][6][2],tNguyenLieu[nType][6][3], 1,1,-1,-1,-1,-1,-1,-1})
		else
			gf_AddItemEx2({tNguyenLieu[nType][6][1],tNguyenLieu[nType][6][2],tNguyenLieu[nType][6][3], 1})
		end
		Talk(1,"",g_szNpcName.." N©ng cÊp trang bÞ míi thµnh c«ng!")
		WriteLogEx("Nang cap trang bi","type "..nUpgradeType.." thµnh c«ng",1, nType)	
	else
		WriteLogEx("Nang cap trang bi","type "..nUpgradeType.." kh«ng thµnh c«ng",1, nType)	
	end
end

function THVS_VSCT()
	tbSay = {
		"TiÕn hµnh n©ng cÊp/THVS_VSCT_Done",
		"Ta chØ xem th«i/gf_DoNothing",	
	}
	Say(g_szNpcName.."Mçi lÇn n©ng cÊp trang bÞ Thiªn H¹ V« Song thµnh V« Song ChiÕn ThÇn cÇn:\n* Trang bÞ cÇn n©ng cÊp (Nãn, gi¸p, quÇn: CÇn c­êng hãa 10 trë lªn)\n* 4 nguyªn liÖu: 100 Thiªn M«n Kim LÖnh, 100 Thiªn Cang LÖnh, 4 Linh KhÝ rùc rì, 10 Cöu thiªn v« cùc ®¬n.\n<color=red>L­u ý: tû lÖ thµnh c«ng 100%.<color>",getn(tbSay),tbSay)
end

function THVS_VSCT_Done()
	
	PutinItemBox("N©ng cÊp trang bÞ" ,1 , "X¸c nhËn muèn thùc hiÖn n©ng cÊp?", THVS_VSCT_FILE, 1)
end