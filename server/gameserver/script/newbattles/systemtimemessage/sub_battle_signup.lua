...
function main()
	if g_WCFG_NEWBATTLES_RESOURCE:IsDateOpen() ~= WEnv.TRUE
			and g_WCFG_NEWBATTLES_VILLAGE:IsDateOpen() ~= WEnv.TRUE
			and g_WCFG_NEWBATTLES_EMPLACEMENT:IsDateOpen() ~= WEnv.TRUE
	then
		return WEnv.RETCODE_NOTOPEN;
	end

	if g_WCFG_NEWBATTLES_RESOURCE:IsTimeOpen() ~= WEnv.TRUE
			and g_WCFG_NEWBATTLES_VILLAGE:IsTimeOpen() ~= WEnv.TRUE
			and g_WCFG_NEWBATTLES_EMPLACEMENT:IsTimeOpen() ~= WEnv.TRUE
	then
		return WEnv.RETCODE_NOTOPEN;
	end
