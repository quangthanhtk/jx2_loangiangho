...
function BTS_CB_Village_Final_Result(szKey,nBattleType,nRecordType,nRecordCount)
	...
	if nResult == 0 then
		...
		sResultStr = "<color=yellow>"..tCampNameZ[nResult].."<color> giµnh chiÕn th¾ng "..tBattleName[nBattleType];
	end;
	Talk(1,"BTS_ViewVillageBattle",format("KÕt qu¶ trËn ®Êu %dh ngµy %d/%d/%d:", nHour, nDay, nMonth, nYear)..sResultStr.."<enter>Phe Tèng t×m ®­îc: <color=yellow>"..nStepSong.."<color><enter>Phe Liªu t×m ®­îc: <color=yellow>"..nStepLiao.."<color>");
end;
...
function BTS_CB_Resource_Final_Result(szKey,nBattleType,nRecordType,nRecordCount)
	...
	Talk(1,"BTS_ViewResourceBattle",format("KÕt qu¶ trËn ®Êu %dh ngµy %d/%d/%d:", nHour, nDay, nMonth, nYear)..sResultStr.."<enter>Sè l­¬ng th¶o phe Tèng: <color=yellow>"..nResSong.."<color><enter>Sè l­¬ng th¶o phe Liªu: <color=yellow>"..nResLiao.."<color>");
end;
...
function BTS_CB_Main_Final_Result(szKey,nBattleType,nRecordType,nRecordCount)
	...
	Talk(1,"BTS_ViewMainBattle",format("KÕt qu¶ trËn ®Êu %dh ngµy %d/%d/%d:", nHour, nDay, nMonth, nYear)..sResultStr.."<enter>§iÓm tÝch lòy phe Tèng: <color=yellow>"..nPubPointSong.."<color> §iÓm tÝch lòy phe Liªu: <color=yellow>"..nPubPointLiao.."<color><enter>Sè n¹n d©n phe Tèng cøu: <color=yellow>"..nHelpRefugeeSong.."<color> Sè n¹n d©n phe Liªu cøu: <color=yellow>"..nHelpRefugeeLiao.."<color><enter>Sè ng­êi th­¬ng vong phe Tèng: <color=yellow>"..nDeathSong.."<color> Sè ng­êi th­¬ng vong phe Liªu: <color=yellow>"..nDeathLiao.."<color>");
end;
