WItemUpgrade:RegType({
    nGroupId = 7,
    szLogTitle = "upgrade_ngulongtuong_thuongungtuong_trangsuc1_100",
    szFeatureName = "N©ng cÊp NLT LÖnh Bµi thµnh Th­¬ng ¦ng T­íng Qu©n LÖnh 100%", nDateOpen = 1, nDateClose = 1, -- ngµy më tÝnh n¨ng, 1= lu«n më; 0= lu«n ®ãng; ®Þnh d¹ng yyyymmdd tøc lµ ®Þnh ngµy s½n
    szPutinTitle = "§Æt vµo NLT LÖnh Bµi",
    nPutinNum = 1,
    szConsumeInfo = " vµ <color=white>1 Ngù Long T­íng Qu©n LÖnh Bµi<color>",
    tbMaterialConsume = {
        nBattlePoint = 6000,
        tbItems = {
    ...
    tbItemAllowUpgrade = {
        { [1] = { "Tèng Ngù Long T­íng Qu©n LÖnh Bµi", { 0, 102, 30013 } }, nSex = 1, nBody = 1, nRoute = 0, nCamp = WEnv.BATTLECAMP_TONG },
        { [1] = { "Tèng Ngù Long T­íng Qu©n LÖnh Bµi", { 0, 102, 30014 } }, nSex = 1, nBody = 2, nRoute = 0, nCamp = WEnv.BATTLECAMP_TONG },
        { [1] = { "Tèng Ngù Long T­íng Qu©n LÖnh Bµi", { 0, 102, 30015 } }, nSex = 2, nBody = 3, nRoute = 0, nCamp = WEnv.BATTLECAMP_TONG },
        { [1] = { "Tèng Ngù Long T­íng Qu©n LÖnh Bµi", { 0, 102, 30016 } }, nSex = 2, nBody = 4, nRoute = 0, nCamp = WEnv.BATTLECAMP_TONG },

        { [1] = { "Liªu Ngù Long T­íng Qu©n LÖnh Bµi", { 0, 102, 30025 } }, nSex = 1, nBody = 1, nRoute = 0, nCamp = WEnv.BATTLECAMP_LIEU },
        { [1] = { "Liªu Ngù Long T­íng Qu©n LÖnh Bµi", { 0, 102, 30026 } }, nSex = 1, nBody = 2, nRoute = 0, nCamp = WEnv.BATTLECAMP_LIEU },
        { [1] = { "Liªu Ngù Long T­íng Qu©n LÖnh Bµi", { 0, 102, 30027 } }, nSex = 2, nBody = 3, nRoute = 0, nCamp = WEnv.BATTLECAMP_LIEU },
        { [1] = { "Liªu Ngù Long T­íng Qu©n LÖnh Bµi", { 0, 102, 30028 } }, nSex = 2, nBody = 4, nRoute = 0, nCamp = WEnv.BATTLECAMP_LIEU },
    },
    tbTargetItem = {
