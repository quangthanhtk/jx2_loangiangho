WItemUpgrade:RegType({
    nGroupId = 2,
    szLogTitle = "upgrade_cc_hh_trangsuc1_100",
    szFeatureName = "N©ng cÊp trang søc DiÖu D­¬ng Thiªn Cung lªn Hµo HiÖp Giíi 100%", nDateOpen = 1, nDateClose = 1, -- ngµy më tÝnh n¨ng, 1= lu«n më; 0= lu«n ®ãng; ®Þnh d¹ng yyyymmdd tøc lµ ®Þnh ngµy s½n
