...
m_tbItem = inherit(WItemBoxBase, {
    szKey = "item_ruong_vang_diahuyencung",
    ...
    tbAwardTypes = {
        [1] = { szName = "Më miÔn phÝ",
                tbItemConsumes = {
                    tbItems = {
                        { tbProp = { 2, 1, 40127 }, nCount = 1 }, -- R­¬ng §Þa HuyÒn Cung
                    },
                },
                tbFixedAward = {
                    { nExp = 2000000 },
                ...
                tbRandomAward = {
                    ...
                    { tbProp = { 2, 1, 9997 }, nStack = 1, nRate = 5.00 }, -- Qu©n c«ng huy hoµng
                    ...
                    { tbProp = { 2, 1, 30370}, nStack = 1, nRate = 0.50 }, -- Thiªn cang lÖnh
