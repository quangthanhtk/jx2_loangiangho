...
Import("\\script\\online_activites\\task_values.lua");--ÈÎÎñ±äÁ¿Í·ÎÄ¼þ
...
function ACT8_Killer()
	...
	if TT_TARGET_Name == "Hoµng Kim b¶o r­¬ng" then
		Earn(100000)
		gf_WriteLogEx("SO LAN MO RUONG TANG KIEM", "NhËn thµnh c«ng", 1, "Hoµng Kim b¶o r­¬ng")		
	end
	if TT_TARGET_Name == "R­¬ng b¹c" then
		ModifyExp(100000)
		gf_WriteLogEx("SO LAN MO RUONG TANG KIEM", "NhËn thµnh c«ng", 1, "R­¬ng b¹c")	
	end
end
-- ------------------------------------------------------------------------------------------------ <Act IX> ----
...
-- ===============Ìå·þ¹æÔò£ºÍ¨¹Ø½±Àø edit by yanjun============================
	...
	for i=1,nMemCount do
		...
		WAward:TangKiem_HoanThanhAi(GetTask(GS_RECORD_CHANCE), 7);
		if GetTask(GS_RECORD_CHANCE) > 1 then --LongDaiKa: hoµn thµnh 1 l­ît 7 ¶i tµng kiÕm
			--ModifyExp(2000000)
			--Msg2Player("B¹n nhËn ®­îc 2000000 ®iÓm kinh nghiÖm")
			--Earn(100000)
			--Msg2Player("B¹n nhËn ®­îc 10 vµng")
		end
		if GetTask(GS_RECORD_CHANCE) == 7 then --LongDaiKa: hoµn thµnh 7 l­ît 7 ¶i tµng kiÕm
...
--	Msg2Player("#"..aGearsIndex[1].." "..aGearsIndex[2].." "..aGearsIndex[3])
	if nFaction == 0 then
		Say("Trong r­¬ng cã 7 ®ång vµng, cã muèn lÊy ra?", 2, "LÊy vµng/#On_Dropis_Get("..a..","..b..","..c..")", "Rêi khái/On_Dropis_Exit")
...
function On_Dropis_Get(a,b,c)
	...
	if GetPlayerFaction() == 0 then
		Earn(70000)
		MU_Msg2Team(GetName().."§· lÊy 7 ®ång vµng.")
		gf_WriteLogEx("TANG KIEM NHAN VANG", "thµnh c«ng", 1, "NhËn 7 vµng")
	else
