...
tBWDHBox_Free = {
	...
	tRand = {
		...
		{{"§én KiÕm Tiªu S­", {2, 1, 31055, 1, 4}, nil, nil, {1, 100}}, 160},
		{{"MËt Th­ Lôc PhiÕn M«n", {2, 1, 31056, 1, 4}, nil, nil, {1, 100}}, 160},
		{{"Hµng hãa bÞ mÊt", {2, 1, 31057, 1, 4}, nil, nil, {1, 100}}, 170},
...
tBWDHBox_IB = {
	...
	tRand = {
		...
		{{"LÖnh Kú Tiªu Côc", {2, 1, 31052, 1, 4}, nil, nil, {1, 100}}, 460},
		{{"LÖnh Bµi Lôc PhiÕn M«n", {2, 1, 31053, 1, 4}, nil, nil, {1, 100}}, 470},
		{{"TÝn VËt Tô B¶o Trai", {2, 1, 31054, 1, 4}, nil, nil, {1, 100}}, 470},
		--{{randYunLing4, {1, nil, 7, nil}}, 900},
		--{{randYunLing5, {1, nil, 7, nil}}, 500},
		--{{randYunLing6, {1, nil, 7, 1}}, 50},
		{{randRingLingTu, {1, nil, nil, nil}}, 100},
		--{{"Tiªn ¢m Th¹ch"    ,{2,1,30674,1}, nil,nil, {1, 100}},2600},
...
tFactionBox_Free = {
	...
	tRand = {
		...
		{{"§én KiÕm Tiªu S­", {2, 1, 31055, 3, 4}, nil, nil, {1, 100}}, 400},
		{{"MËt Th­ Lôc PhiÕn M«n", {2, 1, 31056, 3, 4}, nil, nil, {1, 100}}, 400},
		{{"Hµng hãa bÞ mÊt", {2, 1, 31057, 3, 4}, nil, nil, {1, 100}}, 400},
		--{{randYunLing4, {1, 4, 7, nil}}, 1000},
		--{{randYunLing5, {1, 4, 7, nil}}, 100},
		--{{randYunLing6, {1, 4, 7, 1}}, 50},
		--{{randRingLingTu, {1, 4, nil, nil}}, 400},
		{{"Tiªn ¢m Th¹ch"    ,{2,1,30674,10}, nil,nil, {1, 100}},1955},
...
tFactionBox_IB = {
	nNeedRoom = 2,
	tRequire = {"Thiªn Kiªu LÖnh",2, 97, 236,100},
	tFix = {
		{2,50000000,1},
		{1,"Tói §¸ Quý CÊp 5",{2,1,31024,1,4},0,1},
		{1,"Bét Tr©n Ch©u",{2,102,215,200,4},0,1},
		{1,"HiÖp NghÜa Chi Chøng",{2,1,30912,200,4},0,1},
	},
	tRand = {
		{{"C©y b¸t nh· nhá"    ,{2,0,504,1}, nil,nil, {1, 100}},500},
		{{"C©y B¸t Nh·"    ,{2,0,398,1}, nil,nil, {1, 100}},500},
		...
		{{"TiÓu truyÒn c«ng ®¬n"    ,{2,1,30312,1}, 7,nil, {1, 100}},500},
		{{"TruyÒn C«ng §¬n"    ,{2,1,30313,1}, 7,nil, {1, 100}},500},
		{{"TruyÒn C«ng Kim §¬n"    ,{2,1,30688,1}, 7,nil, {1, 100}},800},
		{{"Vâ l©m b¸o míi"    ,{2,1,30314,1}, 7,nil, {1, 100}},500},
		{{"M¶nh Tu Ch©n YÕu QuyÕt"    ,{2,1,30315,1}, 7,nil, {1, 100}},500},
		{{"VÐ TiÕu Y §ång"    ,{2,1,30493,1}, nil,nil, {1, 100}},1000},
		{{"VÐ TiÕu Y B¹c"    ,{2,1,30492,1}, nil,nil, {1, 100}},500},
		{{"VÐ TiÕu Y Vµng"    ,{2,1,30491,1}, nil,nil, {1, 100}},200},
		{{"LÖnh Kú Tiªu Côc", {2, 1, 31052, 5, 4}, nil, nil, {1, 100}}, 600},
		{{"LÖnh Bµi Lôc PhiÕn M«n", {2, 1, 31053, 5, 4}, nil, nil, {1, 100}}, 600},
		{{"TÝn VËt Tô B¶o Trai", {2, 1, 31054, 5, 4}, nil, nil, {1, 100}}, 600},
...
--ÁªÈü»ý·Ö¾í±¦Ïä
tLianSaiJiFenJuan_Free = {
	nNeedRoom = 1,
	tFix={
		{1,"QuyÓn tÝch ®iÓm Liªn §Êu",{2,1,31174,1},0,1},
	},
}
--ÁªÈü»ý·Ö¾í±¦Ïä
tLianSaiJiFenJuan_IB = {
	nNeedRoom = 1,
	tRequire = {"Thiªn Kiªu LÖnh",2, 97, 236,1},
	tFix={
		{1,"QuyÓn tÝch ®iÓm Liªn §Êu",{2,1,31174,2},0,1},
	},
}

T_BOX = {
	[30692] = {tBWDHBox_Free, tBWDHBox_IB},				--±ÈÎä´ó»á±¦Ïä
	[30693] = {tFactionBox_IB},		--Ê¦ÃÅ·âÉÍ±¦Ïä
	[30688] = {tChuanGongJinDan_IB},				--´«¹¦½ðµ¤
	[31196] = {tLianSaiJiFenJuan_Free, tLianSaiJiFenJuan_IB},--ÁªÈü»ý·ÖÈ¯Àñ°ü
}
...
function onInputNumCallBack_31196_1(nNum)
	onOpenBoxReal(nNum,31196,1)
end
function onInputNumCallBack_31196_2(nNum)
	onOpenBoxReal(nNum,31196,2)
end
...
--			if nParticular == 30692 then
--				Observer:onEvent(SYSEVENT_USE_ITEM_2_1_30692, nOpenIndex);
--			end
			FireEvent("event_ib_cost", 2, 1, nParticular, 1)
			return 1
		end
	end
	return 0
