...
function npc_talk_goto_ggs()
	local tbSay = {}
	local szTitle = "Ta cã thÓ ®­a ng­¬i ®Õn liªn server, chuÈn bŞ xong ch­a?"
	tinsert(tbSay, "\nTa ®· chuÈn bŞ xong/goto_ggs_waiting_room")
...
function npc_talk_back_to_source_gs()
	local tbSay = {}
	local szTitle = "Ta cã thÓ ®­a c¸c h¹ trë vÒ khu vùc chuyªn thuéc, chuÈn bŞ xong ch­a?"
