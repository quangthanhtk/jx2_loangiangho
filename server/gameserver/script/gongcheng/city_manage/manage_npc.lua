...
tRoute2Weapon = 
{
	...
	[22] = {{0,2,6006,"Phi Yªn kiÕm"},},
	[23] = {{0,2,6006,"Phi Yªn kiÕm"},},
	[24] = {{0,3,6001,"Ph¸ Yªn ®ao"},{0,3,6001,"Ph¸ Yªn ®ao"},{0,9,6011,"Vò Yªn bót"}},
	[25] = {{0,3,6001,"Ph¸ Yªn ®ao"},},
	[26] = {{0,9,6011,"Vò Yªn bót"},},
	[27] = {{0,11,6016,"HuyÕt Yªn Tr¶o"},},
	[28] = {{0,11,6017,"HuyÕt Yªn Chi"},{0,11,6018,"S¸o Linh Yªn"},},
	[29] = {{0,11,6017,"HuyÕt Yªn Chi"},},
	[30] = {{0,11,6018,"S¸o Linh Yªn"},},
	[31] = {{0,1,6005,"Tµng Yªn ch©m"},},
	[32] = {{0,2,6006,"Phi Yªn kiÕm"},},
}
...
function fuli_city()
	Say("Ng­êi ch¬i cã X­ng hiÖu ®Æc biÖt cã thÓ l·nh hoÆc chÕ t¹o trang bÞ ®Æc biÖt, toµn bé thµnh viªn trong bang héi ®Òu cã thÓ l·nh VÖ binh Kh«i gi¸p",
		...
		"NhËn trang bÞ danh bé/mk_tixia_equip",
		"NhËn trang bÞ qu©n s­/get_shiye_equip",
...
function mk_taishou_equip()
	Say("<color=green>Qu¶n lý thµnh thÞ<color>: Trang bÞ thµnh chñ cã thêi h¹n vÜnh cöu, nh­ng mét khi mÊt ®i danh hiÖu thµnh chñ th× sÏ kh«ng mang ®­îc, vµ cho dï mang lªn ®­îc th× còng kh«ng cã bÊt kú hiÖu øng nµo.",
		...
		"NhËn thµnh chñ (quËn chóa) kim Ên (8 hßa thÞ bÝch + 15 hoµng kim ®¹i hång bao)/#mk_taishou_ep(0,102,8013)", --0£¬102£¬8013--0£¬102£¬8016
		"NhËn thµnh chñ (quËn chóa) ngo¹i trang (8 hßa thÞ bÝch + 15 hoµng kim ®¹i hång bao)/#mk_taishou_ep(0,109,300)",  --0£¬109£¬300 --0£¬109£¬303
		"Rêi khái/no_say")
end
...
function mk_tixia_equip()
	Say("<color=green>Qu¶n lý thµnh thÞ<color>: Trang bÞ danh bé cã thêi h¹n vÜnh cöu, nh­ng mét khi mÊt ®i danh hiÖu thµnh chñ th× sÏ kh«ng mang ®­îc vµ cho dï mang lªn ®­îc th× còng kh«ng cã bÊt kú hiÖu øng nµo.",
		7,
		"NhËn danh bé chiÕn kh«i (4 hßa thÞ bÝch + 6 hoµng kim ®¹i hång bao)/#mk_tixia_ep(0,103,8005)",  	--0£¬103£¬8005--0£¬103£¬8008
		"NhËn danh bé chiÕn gi¸p (4 hßa thÞ bÝch + 6 hoµng kim ®¹i hång bao)/#mk_tixia_ep(0,100,8005)",  	--0£¬100£¬8005--0£¬100£¬8008
		"NhËn danh bé chiÕn trang (4 hßa thÞ bÝch + 6 hoµng kim ®¹i hång bao)/#mk_tixia_ep(0,101,8005)",  	--0£¬101£¬8005 -0£¬101£¬8008
		"NhËn danh bé Thµnh §« tÇm n· lÖnh  (4 hßa thÞ bÝch + 6 hoµng kim ®¹i hång bao)/#mk_tixia_ep(0,102,8005)",						--0£¬102£¬8005--0£¬102£¬8008
		"NhËn danh bé lÖnh (4 hßa thÞ bÝch + 6 hoµng kim ®¹i hång bao)/#mk_tixia_ep(0,102,8023)",                    	--0£¬102£¬8023--0£¬102£¬8026
...
function get_shiye_equip()
	Say("<color=green>Qu¶n lý thµnh thÞ<color>: Trang bÞ qu©n s­ ®­îc hîp bëi ngo¹i trang qu©n s­ vµ 1 bé trang søc qu©n s­",
		3,
		"NhËn trang søc qu©n s­ (5 hßa thÞ bÝch + 7 hoµng kim ®¹i hång bao)/mk_shiye_ring",
		"NhËn ngo¹i trang qu©n s­ (5  hßa thÞ bÝch  + 7  hoµng kim ®¹i hång bao)/mk_shiye_wai",
		"Rêi khái/no_say")
end

function mk_shiye_ring()
	if BigGetItemCount(0,102,8021) > 0 and BigGetItemCount(0,102,8022) > 0 then
		Say("C¸c h¹ ®· ®ñ 1 bé trang søc qu©n s­ råi.", 0)
		return
	end
	...
	if Zgc_pub_goods_add_chk(2, 100) == 0 then
		return
	end
	...
	if DelItem(2,1,1001,4) == 1 and DelItem(2, 1, 539, 6) == 1 then
		...
		Msg2Player("§¹i hiÖp nhËn ®­îc 1 bé trang søc qu©n s­")
	end
end
...
function res_box_add()
	...
	if (nDay == 3 and nHour < 21) or nDay == 0 or nDay == 1 or nDay == 2 or nDay == 6 or nDay == 5 then
		Talk(1,"","Thêi gian ®Ó l·nh <color=yellow>B¶o r­¬ng tµi nguyªn<color> lµ gi÷a thêi gian <color=yellow>B¶o hé tµi nguyªn chiÕn (mçi tèi thø T­ tõ 20h-21h)<color> vµ <color=yellow>thø N¨m<color> mçi tuÇn")
		return
	end
	--¶Ô»°
	local box_num = GetCityBoxCount(Map_ID_player)
	if box_num <= 0 then
...
function res_box_get()
	...
	--¿Õ¼ä¸ºÖØ¼ì²â
	if Zgc_pub_goods_add_chk(box_num,box_num) ~= 1 then
		return
	end
	--Ôö¼Ó
		--ÏÈ¼õÉÙÊýÁ¿
		if AddCityBoxCount(Map_ID_player,-box_num) > 0 then
			if AddItem(2,1,1210,box_num) == 1 then
				SendTongMessage(GetName().."§· nhËn cho bang m×nh) "..box_num.." R­¬ng tµi nguyªn!")
				WriteLog(GetName().."§· nhËn "..box_num.." R­¬ng tµi nguyªn!")
