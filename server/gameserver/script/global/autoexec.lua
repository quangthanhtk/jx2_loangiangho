...
Import("\\script\\class\\ktabfile.lua");--tabÎÄ¼þ´¦Àí
...
----------------------------------------------------------------------------------------------------
Include("\\script\\warlord\\autoexecute\\server_startup_listener.lua");
----------------------------------------------------------------------------------------------------
...
function main()
	...
	--AddChristmas()		--Ê¥µ®½Ú»î¶¯NPC£¨±£Áô¸øÒÔºóÍâ¹ú½ÚÈÕÓÃ£© --LongDaiKa: t¾t npc Gi¸o sÜ
	AddCheFu();		 --²É¼¯µØÍ¼³µ·ò
...
--	add_0911_npc();
	...
	--Add_ip_npc() -- IP Bonus --LongDaiKa: t¾t npc Anh Chñ/ChÞ Chñ phßng m¸y
...
--	Add_1002_npc() -- Hoa §¨ng TÕt
	...
	Add_PetNpc() -- B¾c §Èu L·o Nh©n --LongDaiKa: t¾t npc B¾c §Èu L·o Nh©n
--	if GetGlbValue(GLB_TSK_SERVER_ID) == 58 then
--		Add_HoangHuynh()  -- NPC dua top Hoang Ung
--	end
    if WDate:Today() < 20240508 then
		Add_HoangHuynh()  -- NPC dua top Hoang Ung
	end
    if WDate:Today() < 20240317 then
        taoNPCNguyenDan2024()
    end
    ---------------Event2024

	--Add_GoldenCard_Manager(); -- B¸n code HKLB ingame --LongDaiKa: t¾t npc L«i Hæ Th­¬ng Nh©n
	Add_XaPhu() -- ThuyÒn gia
	--Add_Pet_TaiXu() -- NPC Th¸i H­ B¹n §ång Hµnh --LongDaiKa: t¾t npc V©n Du Ch©n Nh©n
    ...
    Add_TuBaoThuongNhan() --LongDaiKa: t¾t npc Tô B¶o Th­¬ng Nh©n
	--DragonBoat_2011_npc()    --201109º£ÉÏÁúÖÛÕ½ --LongDaiKa: t¾t npc H¶i ChiÕn TiÕp DÉn Sø
	--LoadNpcList();--¼ÓÔØnpc_list.txtÅäÖÃµÄNPC
	--create_treasuer_chests();--±¦ÏäÉÌÈË --LongDaiKa: t¾t npc Th­¬ng Nh©n B¶o R­¬ng
	--new_task_npc_create();--ÐÂÈÎÎñÏµÍ³NPCÌí¼Ó --LongDaiKa: t¾t npc NhËm Doanh Doanh vµ chuçi nhiÖm vô liªn quan
	...
	if tonumber(date("%y%m%d")) >= 200206 and tonumber(date("%y%m%d")) <= 200213 then
		tuyetanh_baoruong() --Êt mïi B¶o R­¬ng
--		chieuda_baoruong()
--		xichtho_baoruong()
	end
	...
	--Vip_NPC(); 	-- §¹i sø VIP --LongDaiKa: t¾t npc §¹i Sø VIP
	DuongMinhThanh_NPC(); 	-- §¹i sø VIP
...
--	Plus123Pay();
	AddMailBox();--ÓÊÏä
	AddTYNpc();	--Ì«Ò»¹Ø¿¨npc
	--AddLifeSkillNpc(); --Ìí¼ÓÉú»î¼¼ÄÜNPC --LongDaiKa: t¾t npc §ç Tø N­¬ng
    ...
    AddLaodai(); --Ìí¼Ó³èÎïÏà¹Ø¹¦ÄÜNPC
    AddJinke();  --Ìí¼Ó10×ªÏà¹ØNPC
    OnTongActivityStart(); -- °ï»á»î¶¯¡°¾ªÊÀÇÔÔô¡±Ïà¹Ø
    OnFairRankStart(); -- »¯¾³ÅÅÐÐ°ñÏà¹Ø
    AddTranslife10Npc();
    ClearCurrentCityWarWinner();
    AddSanFangTrap(); --Ìí¼ÓÒ»¸öÊÖ¶¯trap£¬´¦ÀíÈý·½ÊÆÁ¦µØÍ¼trapÓÐÂ©¶´µÄÎÊÌâ
    AddNormalMapTrap();
    AutoFunctions:Run() -- KSGVN AutoFunctions
    _w_OnServerStartup();
end;
...
--		local npcIndexcangjian = CreateNpc("Íõ°²Ê¯", "²Ø½£Ê¹Õß", 100,1510,3106);
--		SetNpcScript(npcIndexcangjian, "\\script\\²Ø½£É½×¯\\task_script\\ÈªÖÝ\\²Ø½£Ê¹Õß.lua");
--		print(npcIndexcangjian,"cj")
...
function AddTxNpc()
	...
	SetNpcScript(npcIndex, "\\script\\missions\\taixu_mission\\¿Õ¿ÕºÍÉÐ.lua")
...
function AddNewBattle()
    ...
    --CreateNpcList({
    --    {"B¸n s¸ch","D­¬ng LiÖt",500,1831,3143,"\\script\\newbattles\\song_primary_npc.lua"},
    --    {"Giang hå tuÊn kiÖt","TÇn Thiªn T«ng",500,1711,3238,"\\script\\newbattles\\liao_primary_npc.lua"},
    --});
end;
...
--		{"ÍûÊæ½£", "ÍûÊæ½£", 509,1620,3211, },
--		{"ÔÆÍûÊæ", "ÔÆÍûÊæ", 509,1618,3160, },
		{"R­¬ng ®å Trung Nguyªn","Thñ khè",509,1600,3229,"\\script\\Î÷±±Çø\\À¥ÂØ\\npc\\ÎïÆ·±£¹ÜÈË.lua"},
	--ÌÆÃÅÈÎÏÀ£¨Â·¹ý£©
		{"§­êng Léng NguyÖt", "§­êng Léng NguyÖt", 305,1538,2795, "\\script\\ÖÐÔ­¶þÇø\\ÌÆÃÅ\\npc\\ÌÆÅªÔÂ.lua"},
	--¹âÃ÷¶¥
...
function Liangshan_Entrance()
		local npcIndex = CreateNpc("ThÇn Hµnh Th¸i B¶o §íi T«ng", "ThÇn Hµnh Th¸i B¶o §íi T«ng", 100, 1365, 2871) -- chuyen ve thanh Tuyen Chau (170/179)
...
--		local npcIndex = CreateNpc("ÉñÐÐÌ«±£´÷×Ú", "ÉñÐÐÌ«±£´÷×Ú", tPos[1], tPos[2], tPos[3])
--		AddUnitStates(npcIndex, 7, 0);
--		AddUnitStates(npcIndex, 8, -GetUnitCurStates(npcIndex, 8));
--		SetNpcScript(npcIndex, "\\script\\missions\\liangshan\\npc\\entrynpc_.lua");
--	end
...
function taoNPCNguyenDan2024()
	local nDate = tonumber(date("%y%m%d"))
	local npcIndex = 0
    if nDate >= 100716 then
        npcIndex = CreateNpc("V©n Hi Hßa", "§¹i Sø N¨m Míi", 200, 1376, 2816);
        SetNpcScript(npcIndex, "\\script\\warlord\\online_activities\\tetnguyendan2024\\npc_head.lua");
        npcIndex = CreateNpc("V©n Hi Hßa", "§¹i Sø N¨m Míi", 350,1452,2946);
        SetNpcScript(npcIndex, "\\script\\warlord\\online_activities\\tetnguyendan2024\\npc_head.lua");
    end
end
function Add_HoangHuynh()
    ...
    local npcIndex = 0
    if nDate >= 100716 then
        npcIndex = CreateNpc("TrÇn BÊt Vi", "§ua TOP Sø Gi¶", 200,1407,2857);
        SetNpcScript(npcIndex, "\\script\\warlord\\npcs\\npc_hoanghuynh.lua");
    end
end
...
function tuyetanh_baoruong()	--QuyTy_baoruong
	local tbQT_BaoRuong_Pos = {
					{100, 1497, 3047},	--TuyÖt ¶nh
					{100, 1504, 3039}, 
					{100, 1511, 3049},
					{100, 1504, 3055},
					{300, 1752, 3553},	--ChiÕu D¹
					{300, 1762, 3543},
					{300, 1769, 3553},
					{300, 1762, 3556},
					{350, 1418, 2811},
...
--					{500, 1816, 3003},
	...
	for i = 1, getn(tbQT_BaoRuong_Pos) do
		local npcIndex = CreateNpc("R­¬ng tiÒn","Canh Tý B¶o R­¬ng",tbQT_BaoRuong_Pos[i][1],tbQT_BaoRuong_Pos[i][2],tbQT_BaoRuong_Pos[i][3]);
...
function chieuda_baoruong()	
	...
	for i = 1, getn(tbQT_BaoRuong_Pos) do
		local npcIndex = CreateNpc("R­¬ng tiÒn","Êt Mïi B¶o R­¬ng",tbQT_BaoRuong_Pos[i][1],tbQT_BaoRuong_Pos[i][2],tbQT_BaoRuong_Pos[i][3]);
		SetNpcScript(npcIndex,"\\script\\vng\\quyty_box\\quyty2013_box_npc.lua");
	end
end
...
--	local tNpcs = {
--		{"TYT_XianfengYZB", "ÏÈ·æÑî×Ú±£", {350, 1407, 2853}, "\\script\\missions\\taiyi\\yangzongbao_npc.lua"},
--		{"TYT_XianfengYZB", "ÏÈ·æÑî×Ú±£", {300, 1807, 3349}, "\\script\\missions\\taiyi\\yangzongbao_npc.lua"},
--		{"TYT_XianfengYZB", "ÏÈ·æÑî×Ú±£", {200, 1378, 3063}, "\\script\\missions\\taiyi\\yangzongbao_npc.lua"},
--		{"TYT_XianfengYZB", "ÏÈ·æÑî×Ú±£", {100, 1430, 2791}, "\\script\\missions\\taiyi\\yangzongbao_npc.lua"},
--		{"TYT_XianfengMGY", "ÏÈ·æÄÂ¹ðÓ¢", {350, 1413, 2856}, "\\script\\missions\\taiyi\\muguiying_npc.lua"},
--		{"TYT_XianfengMGY", "ÏÈ·æÄÂ¹ðÓ¢", {300, 1803, 3353}, "\\script\\missions\\taiyi\\muguiying_npc.lua"},
--		{"TYT_XianfengMGY", "ÏÈ·æÄÂ¹ðÓ¢", {200, 1372, 3068}, "\\script\\missions\\taiyi\\muguiying_npc.lua"},
--		{"TYT_XianfengMGY", "ÏÈ·æÄÂ¹ðÓ¢", {100, 1436, 2784}, "\\script\\missions\\taiyi\\muguiying_npc.lua"},
--	};
...
--		end
--	end
local npcIdx1 = CreateNpc("TYT_XianfengYZB", "Tiªn Phong D­¬ng T«n B¶o", 350, 1407, 2853);
	SetNpcScript(npcIdx1, "\\script\\missions\\taiyi\\yangzongbao_npc.lua");
--	print(npcIdx1,"ty1")

local npcIdx2 = CreateNpc("TYT_XianfengMGY", "Tiªn Phong Méc QuÕ Anh", 350, 1413, 2856);
	SetNpcScript(npcIdx2, "\\script\\missions\\taiyi\\muguiying_npc.lua");
---	print(npcIdx2,"ty2")
end
...
function DuongMinhThanh_NPC()
		local nNpcIndex = CreateNpc("L·o phó hé", "§­êng Minh Thµnh", 100, 1446, 2969);
		SetNpcScript(nNpcIndex, "\\script\\online_activites\\2010_04\\activities_02\\npc\\npc_businessman.lua");
end
function AddMailBox()
	CreateNpcList({
		{"mailbox", "Hép th­", 100, 1556, 3082, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 100, 1528, 2867, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 100, 1380, 2905, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 150, 1599, 3158, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 150, 1647, 3066, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 150, 1720, 3076, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 150, 1743, 3198, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 200, 1300, 2995, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 200, 1277, 2776, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 200, 1488, 2952, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 350, 1380, 3060, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 350, 1527, 2862, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 350, 1355, 2867, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 500, 1823, 3045, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 500, 1683, 3100, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 500, 1660, 3218, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 500, 1794, 3210, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 300, 1906, 3606, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 300, 1677, 3658, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 300, 1680, 3485, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 300, 1931, 3479, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 426, 1501, 2991, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 426, 1620, 2954, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 400, 1558, 2907, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 400, 1460, 3063, "\\script\\mail\\mail_box.lua"},
		{"mailbox", "Hép th­", 400, 1531, 3108, "\\script\\mail\\mail_box.lua"},
	});
end
...
function AddLaodai()
	local npcIdx = CreateNpc("laodai", "L·o §¹i", 150, 1626, 3078);
	SetNpcScript(npcIdx, "\\script\\online_activites\\silingmount\\npc\\composer_dlg.lua");
end


function AddTongActivityEnterNpc()
    local npcIdx = CreateNpc("Gia C¸t CÇm", "Sø Gi¶ Ho¹t §éng Bang", 150, 1647, 3176);
    SetNpcScript(npcIdx, "\\script\\missions\\tong_activity\\npc\\npc_send_in.lua")
    -- Öî¸ðÇÙ	Òç±¦Õ«Öî¸ðÇÙ	150	1647	3176	\script\missions\tong_activity\npc\npc_send_in.lua
end

function OnTongActivityStart()
    AddTongActivityEnterNpc();
    SendScript2VM("\\script\\missions\\tong_activity\\tong_activity_value.lua", "TongActivity_OnSvrStart()")
end

function OnFairRankStart()
    local npcIdx1 = CreateNpc("Yªu Thi Ngµn N¨m", "Yªu Thi Ngµn N¨m", 306, 1484, 2941)
    local npcIdx2 = CreateNpc("Thiªn T­íng Thñ Hé", "Thiªn T­íng Thñ Hé", 116, 1691, 3195)
    SetNpcDeathScript(npcIdx1, "\\script\\misc\\fair\\npc\\fair_npc_death.lua")
    SetNpcDeathScript(npcIdx2, "\\script\\misc\\fair\\npc\\fair_npc_death.lua")
    SendScript2VM("\\script\\misc\\fair\\fair.lua", "Fair_OnSvrStart()")
end

function AddTranslife10Npc()
    local npcIdx = CreateNpc("sz_ymg", "U Minh Qu¸i", 307, 1442, 2665);
    SetNpcScript(npcIdx, "\\script\\isolate\\functions\\translife10\\ondeath\\ymg_ondeath.lua")
    CreateNpcList({
        --  {"sz_ymg","ÓÄÚ¤¹Ö",307,1442,2665,"","\\script\\isolate\\functions\\translife10\\ondeath\\ymg_ondeath.lua"},
        { "sz_mzjg", "C¬ Quan Gç", 406, 1540, 2803, "\\script\\isolate\\functions\\translife10\\npcs\\mzjg_npc.lua", },

        { "sz_zfjgy", "TrËn Ph¸p C¬ Quan 1", 416, 1605, 3138, "\\script\\isolate\\functions\\translife10\\npcs\\zfjg1_npc.lua" },
    {"sz_zfjge","TrËn Ph¸p C¬ Quan 2",416,1637,3001,"\\script\\isolate\\functions\\translife10\\npcs\\zfjg2_npc.lua",},
    {"sz_zfjgs","TrËn Ph¸p C¬ Quan 3",416,1844,2920,"\\script\\isolate\\functions\\translife10\\npcs\\zfjg3_npc.lua",},

    {"sz_qydst","Bóa Kú Qu¸i",604,1366,3113,""},
    {"sz_ggg","C¸c C¸ch C­¬ng",600,1548,2901,""},
    {"sz_cldxc","HiÖn tr­êng cßn l¹i",600,1526,3066,"\\script\\isolate\\functions\\translife10\\npcs\\cxqx_npc.lua"},
    {"sz_smr","Ng­êi thÇn bÝ",215,1765,3187,""},
    {"sz_tpzj","DÊu vÕt ch¹y trèn",215,1773,3201,""},
    {"sz_bfdcx","Thõa T­íng BÞ B¾t",207,1442,2873,"\\script\\isolate\\functions\\translife10\\npcs\\cxqx_npc.lua"},
    {"sz_srdst","Thi thÓ th­¬ng nh©n",328,1717,3702,""},
    {"sz_cxqx","Th©n TÝn Thõa T­íng",203,1505,3131,"\\script\\isolate\\functions\\translife10\\npcs\\cxqx_npc.lua"},
    {"sz_cmswtl","Thñ LÜnh VÖ Binh",200,1245,2727,""},
    {"sz_jjtl","Thèng LÜnh CÊm Qu©n",200,1303,2677,""},
    {"sz_qbfz","Ng­êi Bu«n T×nh B¸o",350,1520,2901,""},
	{"sz_lgdys","Liªu Quèc Nguyªn So¸i",600,1530,2884,"\\script\\isolate\\functions\\translife10\\npcs\\cxqx_npc.lua"},
	});
--	SendScript2VM("\\script\\isolate\\functions\\translife10\\npcs\\npc_default.lua", "CreateTranslife10Npc()")
end

function AddJinke()
	local npcIdx = CreateNpc("jinke", "Kim Kha", 6300,1392,3239);
	SetNpcScript(npcIdx, "\\script\\function\\exp2item\\jinke_npc.lua");
end

function ClearCurrentCityWarWinner()
	local SIEGE_MAP_ID = 300		-- ³É¶¼
	local nCurDate = tonumber(date("%Y%m%d"))
	if nCurDate < 20170715 then 
		SetCityWarWinner(SIEGE_MAP_ID, "")
		SetCityWarAttack(SIEGE_MAP_ID, "")
	end
end



function AddSanFangTrap()
	local tPos = {
		{6300,{1395,3222},{1416,3222},"\\script\\missions\\yp\\trap\\sly_trap.lua"},
		{6300,{1416,3222},{1416,3237},"\\script\\missions\\yp\\trap\\sly_trap.lua"},
		{6000,{1357,2920},{1375,2910},"\\script\\missions\\yp\\trap\\tianlongsi_trap.lua"},
		{6100,{1614,3268},{1623,3268},"\\script\\missions\\yp\\trap\\qiongjie_trap.lua"},
		{6100,{1623,3261},{1623,3268},"\\script\\missions\\yp\\trap\\qiongjie_trap.lua"},
		--ÈöÍø×¥ÂÒÅÜµÄÍæ¼Ò
		{6000,{1301,2851},{1303,2822},"\\script\\missions\\yp\\trap\\tianlongsi_trap.lua"},
		{6000,{1289,2816},{1264,2818},"\\script\\missions\\yp\\trap\\tianlongsi_trap.lua"},
		{6000,{1289,2817},{1288,2749},"\\script\\missions\\yp\\trap\\tianlongsi_trap.lua"},
		{6000,{1337,2622},{1276,2625},"\\script\\missions\\yp\\trap\\tianlongsi_trap.lua"},
		{6000,{1367,2892},{1346,2916},"\\script\\missions\\yp\\trap\\tianlongsi_trap.lua"},

		{6100,{1612,3288},{1633,3279},"\\script\\missions\\yp\\trap\\qiongjie_trap.lua"},
		{6100,{1520,3315},{1554,3262},"\\script\\missions\\yp\\trap\\qiongjie_trap.lua"},
		{6100,{1536,3200},{1643,3066},"\\script\\missions\\yp\\trap\\qiongjie_trap.lua"},
		{6100,{1652,3128},{1532,3242},"\\script\\missions\\yp\\trap\\qiongjie_trap.lua"},
	}
...
function AddNormalMapTrap()
	local tPos = {
		{301,{1387,2765},{1401,2769},"\\script\\ÖÐÔ­¶þÇø\\³É¶¼¸®Î÷\\trap\\trap_chengdufuxi.lua"},
		{301,{1384,2757},{1388,2791},"\\script\\ÖÐÔ­¶þÇø\\³É¶¼¸®Î÷\\trap\\trap_chengdufuxi.lua"},
		{301,{1384,2757},{1407,2758},"\\script\\ÖÐÔ­¶þÇø\\³É¶¼¸®Î÷\\trap\\trap_chengdufuxi.lua"},

		{301,{1452,3229},{1443,3213},"\\script\\ÖÐÔ­¶þÇø\\³É¶¼¸®Î÷\\trap\\trap_chengdufuxi.lua"},
		{301,{1452,3229},{1468,3208},"\\script\\ÖÐÔ­¶þÇø\\³É¶¼¸®Î÷\\trap\\trap_chengdufuxi.lua"},

		{301,{1606,3222},{1591,3207},"\\script\\ÖÐÔ­¶þÇø\\³É¶¼¸®Î÷\\trap\\trap_chengdufuxi.lua"},
		{301,{1606,3222},{1614,3208},"\\script\\ÖÐÔ­¶þÇø\\³É¶¼¸®Î÷\\trap\\trap_chengdufuxi.lua"},

		{301,{1376,3229},{1389,2760},"\\script\\ÖÐÔ­¶þÇø\\³É¶¼¸®Î÷\\trap\\trap_chengdufuxi.lua"},
		{301,{1376,3229},{1614,3208},"\\script\\ÖÐÔ­¶þÇø\\³É¶¼¸®Î÷\\trap\\trap_chengdufuxi.lua"},
	}
