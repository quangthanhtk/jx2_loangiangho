...
function offline_exchange_talk_main()
	...
	if nPlayerMapId == 219 then
     		...
     		if nDist >= 0 and nDist <= 3 then
     			Msg2Player("Khu vùc nµy kh«ng thÓ tiÕn hµnh ñy th¸c, vui lßng thö l¹i t¹i vŞ trİ kh¸c.")
     			return
     		end
     	end
	...
	local tbDialog = {
		...
		"Ta muèn sö dông thêi gian ñy th¸c ®æi lÊy Tô Linh Hoµn Ch©n Khİ ñy th¸c/get_offline_juling_talk",
		"Rêi khái/no"
		};
...
function confirm_use_baiju(BaijuType)
	if BaijuType == 0 then
		Say("X¸c ®Şnh sö dông <color=yellow>B¹ch CÇu Hoµn<color> quy ®æi thµnh ®iÓm kinh nghiÖm?", 3, "§ång ı/yes_get_offline_baiju", "trë l¹i/get_offline_baiju", "Rêi khái/no")
	elseif BaijuType == 1 then
		Say("X¸c ®Şnh sö dông <color=yellow>§¹i B¹ch CÇu Hoµn<color> quy ®æi thµnh ®iÓm kinh nghiÖm?", 3, "§ång ı/yes_get_offline_baiju1", "trë l¹i/get_offline_baiju", "Rêi khái/no")
	elseif BaijuType == 2 then
		Say("X¸c ®Şnh sö dông <color=yellow>B¹ch CÇu Tiªn §¬n<color> quy ®æi thµnh ®iÓm kinh nghiÖm?", 3, "§ång ı/yes_get_offline_baiju2", "trë l¹i/get_offline_baiju", "Rêi khái/no")
	end
end
...
function yes_get_offline_baiju()
	...
	if GainExpLimit <= GiveExpPerMin then
		Say("§iÓm tİch lòy kinh nghiÖm cña c¸c h¹ ®· ®¹t giíi h¹n, kh«ng thÓ quy ®æi.", 0)
		return
	end
...
function confirm_use_liushen(LiushenType)
	if LiushenType == 0 then
		Say("X¸c ®Şnh sö dông <color=yellow>Lôc ThÇn Hoµn<color> quy ®æi thµnh ®iÓm danh väng?", 3, "§ång ı/yes_get_offline_liushen", "trë l¹i/get_offline_liushen", "Rêi khái/no")
	elseif LiushenType == 1 then
		Say("X¸c ®Şnh sö dông <color=yellow>C­êng HiÖu Lôc ThÇn Hoµn<color> quy ®æi thµnh ®iÓm danh väng?", 3, "§ång ı/yes_get_offline_liushen1", "trë l¹i/get_offline_liushen", "Rêi khái/no")
	elseif LiushenType == 2 then
		Say("X¸c ®Şnh sö dông <color=yellow>Lôc ThÇn Tiªn §¬n<color> quy ®æi thµnh ®iÓm danh väng?", 3, "§ång ı/yes_get_offline_liushen2", "trë l¹i/get_offline_liushen", "Rêi khái/no")
	end
end
...
function confirm_use_sanqing(SanqingType)
	if SanqingType == 0 then
		Say("X¸c ®Şnh sö dông <color=yellow>Tam Thanh Hoµn<color> ®æi ®iÓm Cèng HiÕn S­ M«n?", 3, "§ång ı/yes_get_offline_sanqing", "trë l¹i/get_offline_sanqing", "Rêi khái/no")
	elseif SanqingType == 1 then
		Say("X¸c ®Şnh sö dông <color=yellow>C­êng HiÖu Tam Thanh Hoµn<color> ®æi ®iÓm Cèng HiÕn S­ M«n?", 3, "§ång ı/yes_get_offline_sanqing1", "trë l¹i/get_offline_sanqing", "Rêi khái/no")
	elseif SanqingType == 2 then
		Say("X¸c ®Şnh sö dông <color=yellow>Tam Thanh Tiªn §¬n<color> ®æi ®iÓm Cèng HiÕn S­ M«n?", 3, "§ång ı/yes_get_offline_sanqing2", "trë l¹i/get_offline_sanqing", "Rêi khái/no")
	end
end
