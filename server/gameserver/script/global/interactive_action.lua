...
Import("\\script\\lib\\lingshi_head.lua"); --ÁéÊ¯Í·ÎÄ¼þ
...
tInteractiveMap = {
    [INTERACTIVE_SHARE_RIDE] = "share_ride",--0-- Ë«ÈË¹²Æï
    [INTERACTIVE_SHARE_HAND] = "share_hand",-- 1		-- Ë«ÈËÐ¯ÊÖ
    [INTERACTIVE_SHARE_BACK] = "share_back",-- 2		-- GG±³MM
    [INTERACTIVE_SHARE_CHEST] = "share_chest",-- 3		-- GG±§MM
    [INTERACTIVE_KISS] = "kiss",-- 4			-- Ç×ÎÇ
    [INTERACTIVE_COMFORT] = "comfort",-- 5			-- °²Î¿
    [INTERACTIVE_KOTOW] = "kotow",-- 6			-- °Ý
    [INTERACTIVE_HELP] = "help",-- 7			-- °ïÃ¦
    [INTERACTIVE_SORROW] = "sorrow",-- 8			-- ±¯ÉË
    [INTERACTIVE_READY_GO] = "ready_go",-- 9		-- ³ö·¢
    [INTERACTIVE_ACT_UP] = "act_up",-- 10			-- µ÷Æ¤
    [INTERACTIVE_CRAZY] = "crazy",-- 11			-- ·¢¿ñ
    [INTERACTIVE_KNEE_DOWN] = "knee_down",-- 12		-- ¹òÏÂ
    [INTERACTIVE_SHY] = "shy",-- 13			-- º¦Ðß
    [INTERACTIVE_BOW] = "bow",--14			-- ¾Ï¹ª
    [INTERACTIVE_CLAPS] = "claps",-- 15			-- ÅÄÊÖ
    [INTERACTIVE_MARRIAGE] = "marriage",-- 16		-- Çó»é
    [INTERACTIVE_ANGRY] = "angry",-- 17			-- ÉúÆø
    [INTERACTIVE_VICTORY] = "victory",-- 18		-- Ê¤Àû
    [INTERACTIVE_COOL] = "cool",-- 19			-- Ë£¿á
    [INTERACTIVE_LAY_DOWN] = "lay_down",-- 20		-- ÌÉÏÂ
    [INTERACTIVE_DEFY] = "defy",-- 21			-- ÌôÐÆ
    [INTERACTIVE_PUZZLED] = "puzzled",-- 22		-- ÒÉ»ó
    [INTERACTIVE_FAINT] = "faint",-- 23			-- ÔÎµ¹
    [INTERACTIVE_BYEBYE] = "byebye",-- 24 		-- ÕÐÊÖ
    [INTERACTIVE_CONFIDENCE] = "confidence",-- 25		-- ×ÔÐÅ
    [INTERACTIVE_GENTLE] = "gentle",-- 26			-- ×÷Ò¾
    [INTERACTIVE_SIT] = "sit",-- 27			-- ×øÏÂ
}
