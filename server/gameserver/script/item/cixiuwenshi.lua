...
function OnUse_real(nItemIdx)
	...
	szTitle = format("%s\n<color=red>%s<color>", szTitle, "UÈn linh cÊp 7 trë lªn, khi chän dßng chän 't«i muèn uÈn linh' sÏ lµm cho ngo¹i trang cã thêi h¹n h¬n 60 ngµy trë thµnh cã thêi h¹n 60 ngµy, nÕu thêi h¹n cña ngo¹i trang Ýt 60 ngµy th× sau khi uÈn linh thêi h¹n sÏ kh«ng bÞ thay ®æi.")
...
function _Collect(nItemIdx)
	...
	if nCollectIndex < 0 then
		Talk(1,"","Kh«ng thÓ l­u tr÷ vËt phÈm nµy");
		return
	end
