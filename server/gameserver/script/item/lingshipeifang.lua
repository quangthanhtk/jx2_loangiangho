...
function OnUse(nItemIndex)
	...
	if nId2 == nil then 
		Talk(1,"","<color=green>Yªu cÇu nguyªn liÖu<color>: thuéc tÝnh linh th¹ch lµ <color=yellow>"..sReName.."<color>, vÞ trÝ kh¶m lµ 1 <color=yellow> "..tXqPos[nXqRow][1].."<color>-<color=yellow>"..nLv.."<color>Linh th¹ch cã thuéc tÝnh cïng cÊp <color=yellow>"..nNum.."<color> \n<color=green>Linh th¹ch sinh thµnh<color>: Thuéc tÝnh linh th¹ch lµ <color=yellow>"..sReName2.."<color>, vÞ trÝ kh¶m lµ 1 <color=yellow> "..tXqPos[nScXqRow][1].."<color>-<color=yellow>"..nScLv.."lóc hîp thµnh <color>linh th¹ch cÊp<color=yellow> 1 <color> \n<color=red>, ®em linh th¹ch phèi ph­¬ng vµ ®­îc phèi ph­¬ng nÐm vµo trong hîp thµnh lan, mçi lÇn chØ dùa theo 1 lo¹i phèi ph­¬ng hîp thµnh, nÕu kh«ng dùa theo ngÉu nhiªn mµ hîp thµnh. Chó ý: ngoµi thuéc tÝnh linh th¹ch ra, ®¼ng cÊp linh th¹ch ph¶i phï hîp víi yªu cÇu.<color>");	
	else
		Talk(1,"","<color=green>Yªu cÇu nguyªn liÖu<color>: thuéc tÝnh linh th¹ch lµ <color=yellow>"..sReName.."<color>, vÞ trÝ kh¶m lµ 1 <color=yellow> "..tXqPos[nXqRow][1].."<color>-<color=yellow>"..nLv.."<color>Linh th¹ch cã thuéc tÝnh cïng cÊp <color=yellow>"..nNum.."<color> \n cïng víi: thuéc tÝnh linh th¹ch lµ <color=yellow>"..sReName3.."<color>, vÞ trÝ kh¶m lµ 1 <color=yellow> "..tXqPos[nXqRow2][1].."<color>-<color=yellow>"..nLv2.."<color>Linh th¹ch cã thuéc tÝnh cïng cÊp <color=yellow>"..nNum2.."<color> \n<color=green>Linh th¹ch sinh thµnh<color>: Thuéc tÝnh linh th¹ch lµ <color=yellow>"..sReName2.."<color>, vÞ trÝ kh¶m lµ 1 <color=yellow> "..tXqPos[nScXqRow][1].."<color>-<color=yellow>"..nScLv.."lóc hîp thµnh <color>linh th¹ch cÊp<color=yellow> 1 <color> \n<color=red>, ®em linh th¹ch phèi ph­¬ng vµ ®­îc phèi ph­¬ng nÐm vµo trong hîp thµnh lan, mçi lÇn chØ dùa theo 1 lo¹i phèi ph­¬ng hîp thµnh, nÕu kh«ng dùa theo ngÉu nhiªn mµ hîp thµnh. Chó ý: ngoµi thuéc tÝnh linh th¹ch ra, ®¼ng cÊp linh th¹ch ph¶i phï hîp víi yªu cÇu.<color>");
	end
end