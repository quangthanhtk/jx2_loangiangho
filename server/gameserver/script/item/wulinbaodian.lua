...
function OnUse()
	local strtab = {
		"Dïng 5 Ngò Hµnh MËt TÞch ®æi 1 Ngò Hµnh MËt TÞch toµn tËp (Ch¾c ch¾n luyÖn ®­îc 10 thµnh)/#change_miji(1)",
		"Dïng 1 L¨ng Ba Vi Bé ®æi 1 L¨ng Ba Vi Bé toµn tËp (Ch¾c ch¾n luyÖn ®­îc 10 thµnh)/#change_miji(2)",
...
function change_miji(nType)
	if nType == 1 then
		Say("B¹n x¸c ®Þnh dïng 5 Ngò Hµnh MËt TÞch ®æi 1 Ngò Hµnh MËt TÞch toµn tËp? (Ch¾c ch¾n luyÖn ®­îc 10 thµnh). Vâ L©m B¶o §iÓn sÏ biÕn mÊt.",
			2,
			"§ång ý/#confirm_change_miji(1)",
			"Kh«ng, ta nhÇm!/nothing");
	elseif nType == 2 then
		Say("B¹n x¸c ®Þnh dïng 1 L¨ng Ba Vi Bé ®æi 1 L¨ng Ba Vi Bé toµn tËp (Ch¾c ch¾n luyÖn ®­îc 10 thµnh) chø? Vâ L©m B¶o §iÓn công sÏ bÞ mÊt!",
			2,
