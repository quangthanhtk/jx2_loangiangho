...
function OnUse(nParticular)
	...
	if nRoute ~= 20 then
		Talk(1, "", "ChØ cã ph¸i hiÖp ®éc míi sö dông ®­îc.")
		return 0
	end
	local nMapID = GetWorldPos()
	if nMapID == 6300 or nMapID == 6200 or nMapID == 6100 or nMapID == 6000 or nMapID == 887 or nMapID == 606 or (nMapID == 884 and GetFightState() == 0) then 
		Talk(1,"","Khu vùc nµy kh«ng thÓ sö dông Phong Thi Phï !!!");
		return 0;
	end;
