...
--	{{"´ó°ü¶·ÆÇÁî",2,95,1517},{"¶·ÆÇÁî",{2,95,1511,250}}},
	...
	{{"Bao Ph¸o Tinh ChÕ",2,200,72},{"Ph¸o Tinh ChÕ",{2,200,67,10}}},	
	{{"Bao ThiÖp Vµng Xu©n Míi",2,200,73},{"ThiÖp Vµng Xu©n Míi",{2,200,62,100}}},
}
...
function OnUse(nItemIdx)
	...
	local tSel = {
		format("Dïng ngay/#onOpen(%d,%d)", nItemIdx,nType),
		"§ãng/nothing",
	}
