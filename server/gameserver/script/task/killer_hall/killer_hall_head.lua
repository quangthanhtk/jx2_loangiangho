...
tExpAward = {	--Ïä×ÓËù¸øµÄ¾­Ñé
	[NPC_TYPE_XIANGZHU] = {100000},
	[NPC_TYPE_FUTANGZHU] = {2000000},
	[NPC_TYPE_LIDAZUI] = {6000000},
	}
...
tbThuongMoRuong = {
	[NPC_TYPE_XIANGZHU] = {2,1,31244,10},
	[NPC_TYPE_FUTANGZHU] = {2,1,31244,20},
	[NPC_TYPE_LIDAZUI] = {2,1,31244,40},
}
...
tRouteInfo = --¼¼ÄÜID£¬¼¼ÄÜ×î¸ßµÈ¼¶£¬ÎäÆ÷ĞÅÏ¢
{
	...
	[25] = {1065,7,{{"M·nh Hæ ch­a gi¸m ®Şnh",2,1,385}}},
	[26] = {1093,7,{{"M·nh Hæ ch­a gi¸m ®Şnh",2,1,385}}},
	[27] = {1143,7,{{"M·nh Hæ ch­a gi¸m ®Şnh",2,1,385}}},
	[29] = {1176,7,{{"M·nh Hæ ch­a gi¸m ®Şnh",2,1,385}}},
	[30] = {1229,7,{{"M·nh Hæ ch­a gi¸m ®Şnh",2,1,385}}},
	[31] = {1882,7,{{"M·n Thiªn Hoa Vò ch­a gi¸m ®Şnh",2,1,378}}},--"ÌÆÃÅ",
	[32] = {1896,7,{{"M·nh Hæ ch­a gi¸m ®Şnh",2,1,385}}},
}
...
function KH_Normal_Award(nType)
	...
	if nType == 3 then
		gf_AddItemEx2({2,1,30499,2}, "Hu©n ch­¬ng anh hïng", "Mo ruong", "nhËn")
	end
...
function VIET_1010_Bhta4(nType)
	...
	if nTeamSize > 1 then
		for i=1,nTeamSize do
			...
			if IsPlayerDeath() == 0 then
				if nType == NPC_TYPE_XIANGZHU then
					gf_AddItemEx2({2,1,31244,10}, "M¶nh c¬ quan mÆc gia", "Bang Hoi Tinh Anh 6", "më r­¬ng H­¬ng Chñ")
				elseif nType == NPC_TYPE_FUTANGZHU then
					gf_AddItemEx2({2,1,31244,20}, "M¶nh c¬ quan mÆc gia", "Bang Hoi Tinh Anh 6", "më r­¬ng Phã §­êng Chñ")
				elseif nType == NPC_TYPE_LIDAZUI then
					gf_AddItemEx2({2,1,31244,40}, "M¶nh c¬ quan mÆc gia", "Bang Hoi Tinh Anh 6", "më r­¬ng Lı §¹i Chñy")
				end
			end
		end
		PlayerIndex = nOldPlayerIdx
