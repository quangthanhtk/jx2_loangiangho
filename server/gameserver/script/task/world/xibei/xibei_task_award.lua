...
function confirm_wp_award(nId)
	...
	if nRoute == 0 or nRoute == 1 or nRoute == 5 or nRoute == 7 or nRoute == 10 or nRoute == 13 or nRoute == 16 or nRoute == 19 then
		...
		if not tAward or not tAward[nRoute] then
			WriteLog("NhiÖm vô T©y B¾c: Ng­êi ch¬i"..GetName().."Thu vò khÝ thÊt b¹i, ký hiÖu thÊt b¹i: ".."No award config this route, nRoute ="..(nRoute or 0) );
			return
		end
		...
		if add_flog == 1 then
			...
			WriteLog("NhiÖm vô T©y B¾c: Ng­êi ch¬i"..GetName().."Thu vò khÝ thÊt b¹i, ký hiÖu thÊt b¹i: "..add_flog..", nRoute ="..nRoute );
		end
	end 
end
