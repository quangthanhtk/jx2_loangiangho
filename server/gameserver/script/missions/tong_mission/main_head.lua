...
Import("\\script\\missions\\tong_mission\\fields.lua");
Import("\\script\\missions\\tong_mission\\position.lua");
Import("\\script\\missions\\tong_mission\\stage\\npc_info.lua");
Import("\\script\\missions\\tong_mission\\stage\\stage1.lua");
Import("\\script\\missions\\tong_mission\\stage\\stage2.lua");
Import("\\script\\missions\\tong_mission\\stage\\stage3.lua");
Import("\\script\\missions\\tong_mission\\stage\\stage4.lua");
Import("\\script\\missions\\tong_mission\\stage\\stage5.lua");
Import("\\script\\missions\\tong_mission\\stage\\stage6.lua");
