...
function _on_open_box_tong(tBox, npcIndex)
	...
	if nRetIndex > 0 then
		...
		if tBox[5] == 0 then
			...
			FireEvent("event_mission_box_award", "taiyi", "copper", 0)
		elseif tBox[5] == 1 then
			vaf_award_api("tTYTTongBox_H");
			FireEvent("event_mission_box_award", "taiyihero", "copper", 0)
		end
	else
...
function _box_yin_imdaye(npcIndex)
  ...
  if not szConsume or 1~=CustomAwardCheckAndConsumeGroup(szConsume,1) then
	...
	if tBox[6] == 0 then
		...
		FireEvent("event_mission_box_award", "taiyi", "silver", 0)
	elseif tBox[6] == 1 then
		vaf_award_api("tTYTYinBox_H");
		FireEvent("event_mission_box_award", "taiyihero", "silver", 0)
	end
...
function _on_open_box_jin(tBox, npcIndex)
	...
	if tBox[9] == 0 then
		...
		FireEvent("event_mission_box_award", "taiyi", "gold", 0)
	elseif tBox[9] == 1 then
		vaf_award_api("tTYTJinBox_H");
		FireEvent("event_mission_box_award", "taiyihero", "gold", 0)
	end
end
