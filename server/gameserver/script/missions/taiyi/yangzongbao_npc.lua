...
function main()
	if g_WCFG_THAINHATTHAP:IsDateOpen(1) ~= WEnv.TRUE then
	...
	local strTab = {
		...
		--format("Ta muèn tham gia Th¸i NhÊt Th¸p-Th­êng (Tèn %s)/Talk_1_2", "Tinh Lùc*"..TYT_JOIN_COST_JINGLI[2][1]),
		--format("Ta muèn tham gia Th¸i NhÊt Th¸p-Th­êng (§éi tr­ëng tèn %s)/Talk_1_2_IB", TYT_JOIN_COST_ITEM[2][1][2].."*"..TYT_JOIN_COST_ITEM[2][1][1][4]),
