...
function main()
	...
	local strTab = {
		...
		--format("Ta muèn tham gia Th¸i NhÊt Th¸p-Anh Hïng (Tèn %s)/Talk_2", "Tinh Lùc*"..TYT_JOIN_COST_JINGLI[2][2]),
		--format("Ta muèn tham gia Th¸i NhÊt Th¸p-Anh Hïng (§éi tr­ëng tèn %s)/Talk_2_IB", TYT_JOIN_COST_ITEM[2][2][2].."*"..TYT_JOIN_COST_ITEM[2][2][1][4]),
...
--		Talk(1, "", g_szNpcName..format("Ó¢ÐÛÌ«Ò»ËþÃ¿ÖÜ[%s]¿ª·Å", "ÖÜÈý£¬ÖÜÁù£¬ÖÜÈÕ"));
--		return 0
--	end
	return 1
end
