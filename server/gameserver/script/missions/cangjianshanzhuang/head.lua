...
Import("\\settings\\static_script\\lib\\val2str.lua");
Include("\\script\\missions\\cangjianshanzhuang\\mission_award.lua")
...
tNpcCfg = {
	[1] = {
--		wrx = {"ÎâÈÊÐÓ","ÕóÁé","\\script\\missions\\cangjianshanzhuang\\wrx_npc.lua",nil, CampPlayer,0},
...
----    	cjzl = {"²Ø½£¸ó×Ü¹Ü90", "²Ø½£³¤ÀÏ", nil, nil, CampPlayer, 0},
----    	cjxj = {"´óÐ¡½ã90", "²Ø½£Ð¡½ã", nil, nil, CampPlayer, 0},
----    	nyzg = {"É½×¯ÄÚÔº×Ü¹Ü90", "ÄÚÔº×Ü¹Ü", nil, nil, CampPlayer, 0},
----    	wyzg = {"²Ø½£É½×¯ÍâÔº×Ü¹Ü90", "ÍâÔº×Ü¹Ü", nil, nil, CampPlayer, 0},
--    
--    	cyfy = {"Ó¥Öù", "²ÔÓ¥·âÓ¡", nil, nil, CampEnemy, 0},
--    	qlfy = {"ÁúÖù", "ÇàÁú·âÓ¡", nil, nil, CampEnemy, 0},
--    	hffy = {"·ïÖù", "»ð·ï·âÓ¡", nil, nil, CampEnemy, 0},
--    	bhfy = {"»¢Öù", "°×»¢·âÓ¡", nil, nil, CampEnemy, 0},
--    	yl = {"pozhenying", "Ó¥Áé", nil, nil, CampPlayer, 0},
--    	ll = {"pozhenlong", "ÁúÁé", nil, nil, CampPlayer, 0},
--    	fl = {"pozhenfeng", "·ïÁé", nil, nil, CampPlayer, 0},
--    	hl = {"pozhenhu", "»¢Áé", nil, nil, CampPlayer, 0},
    	...
    	--boss6 = {"½£Ä§½­±ðº×","½£Ä§½­±ðº×", nil, nil, CampEnemy, 0},--ºìÓ¡½ÌÖ÷
    	...
    	fish2_2 = {"Méc Nh©n Yªu", "Méc Nh©n Yªu", thisFile,nil,CampEnemy,0},
    	fish2_3 = {"Háa DiÔm Th¹ch Nh©n Khæi Lçi", "Háa DiÔm Th¹ch Nh©n Khæi Lçi", thisFile,nil,CampEnemy,0},
    	boss2 = {"C¬ Quan Bµn Long Trô","C¬ Quan Bµn Long Trô", thisFile, nil, CampEnemy, 0},
    	
    	fish3 = {"Háa DiÔm Th¹ch Nh©n Khæi Lçi", "Háa DiÔm Th¹ch Nh©n", nil,nil,CampEnemy,0},
	},
	[2] = {
--		wrx = {"ÎâÈÊÐÓ","ÕóÁé","\\script\\missions\\cangjianshanzhuang\\wrx_npc.lua",nil, CampPlayer,0},
    	jtyl = {"V¹n KiÕm Giang BiÖt H¹c","Giang BiÖt H¹c",thisFile,nil,CampPlayer,0},
...
--    	hl = {"pozhenhu", "»¢Áé", nil, nil, CampPlayer, 0},
    	...
    	boss3 = {"TZWJ_BOSS3_1","Thiªn KiÕm DiÖp Phong-Né", thisFile, nil, CampEnemy, 0},--
    	boss4 = {"TZWJ_BOSS3_2","§Þa KiÕm DiÖp B¨ng-Né", thisFile, nil, CampEnemy, 0},--
    	boss5 = {"TZWJ_BOSS3_3","Nh©n KiÕm DiÖp Méng-Né", thisFile, nil, CampEnemy, 0},--
    	--boss6 = {"½£Ä§½­±ðº×","½£Ä§½­±ðº×", nil, nil, CampEnemy, 0},--ºìÓ¡½ÌÖ÷
    	boss7 = {"TZWJ_BOSS4","Ma KiÕm N«-Né", thisFile, nil, CampEnemy, 0},--
    	
    	fish1_1 = {"TZWJ_FM1_1", "Binh M· Dòng-Né", thisFile,nil,CampEnemy,0},
    	fish1_2 = {"TZWJ_FM1_2", "X¹ Thñ Binh M· Dòng-Né", thisFile,nil,CampEnemy,0},
    	fish1_3 = {"TZWJ_FM1_3", "Binh M· B¸ch Phu Tr­ëng-Né", thisFile,nil,CampEnemy,0},
    	boss1 = {"TZWJ_BOSS1","Thèng LÜnh T­îng-Né", thisFile, nil, CampEnemy, 0},--
    	boss1_1 = {"TZWJ_BOSS1_1","Thèng LÜnh T­îng-Né (Ph©n th©n)", nil, 30, CampEnemy, 0},--
    	
    	fish2_1 = {"TZWJ_FM2_1", "Th¹ch Nh©n Khæi Lçi-Né", thisFile,nil,CampEnemy,0},
    	fish2_2 = {"TZWJ_FM2_2", "Méc Nh©n Yªu-Né", thisFile,nil,CampEnemy,0},
    	fish2_3 = {"TZWJ_FM2_3", "Háa DiÔm Th¹ch Nh©n-Né", thisFile,nil,CampEnemy,0},
    	boss2 = {"TZWJ_BOSS2","C¬ Quan Bµn Long Trô-Né", thisFile, nil, CampEnemy, 0},
    	
    	fish3 = {"TZWJ_FM2_3", "Háa DiÔm Th¹ch Nh©n-Né", nil,nil,CampEnemy,0},
	},
}
...
function get_open_type()
	return GetMissionV(tbJZMY.mv_open_type)
end

-------Ò»Ð©¹«¹²Êý¾Ý---------------------------------------------
tNpcs = {
	wrx = {"Ng« Nh©n H¹nh","TrËn Linh","\\script\\missions\\cangjianshanzhuang\\wrx_npc.lua",nil, CampPlayer,0},
	--yzq = {"Ò¶×ÓÇð½£Ú£", "Ò¶×ÓÇð", thisFile, nil, CampPlayer, 0},
--	cjzl = {"²Ø½£¸ó×Ü¹Ü90", "²Ø½£³¤ÀÏ", nil, nil, CampPlayer, 0},
--	cjxj = {"´óÐ¡½ã90", "²Ø½£Ð¡½ã", nil, nil, CampPlayer, 0},
--	nyzg = {"É½×¯ÄÚÔº×Ü¹Ü90", "ÄÚÔº×Ü¹Ü", nil, nil, CampPlayer, 0},
...
--	boss3 = {"Ìì½£Ò¶·ç","Ìì½£Ò¶·ç", thisFile, nil, CampEnemy, 0},
--	boss4 = {"µØ½£Ò¶±À","µØ½£Ò¶±À", thisFile, nil, CampEnemy, 0},
--	boss5 = {"ÈË½£Ò¶ÃÎ","ÈË½£Ò¶ÃÎ", thisFile, nil, CampEnemy, 0},
	boss6 = {"KiÕm Ma Giang BiÖt H¹c","KiÕm Ma Giang BiÖt H¹c", nil, nil, CampEnemy, 0},--ºìÓ¡½ÌÖ÷
--	boss7 = {"Íò½£Ä§½£Å«","Ä§½£Å«", thisFile, nil, CampEnemy, 0},--
};
...
function ttd_createJTYL(nStage)
	...
	if tJTYLPos[nCurStage] then
		local nNpcIDX = ttd_createSomeNpc(npcs.jtyl,tJTYLPos[nCurStage]); --´´½¨½£Ù×Ò¶Á¿
		ttd_ChangeNpc2Talk(nNpcIDX);
		nNpcIDX = ttd_createSomeNpc(npcs.lf,tLfPos[nCurStage]); --´´½¨Âå·É
		ttd_ChangeNpc2Talk(nNpcIDX);
		nNpcIDX = ttd_createSomeNpc(npcs.qrs,tQrsPos[nCurStage]); --´´½¨ÇïÈôË®
		ttd_ChangeNpc2Talk(nNpcIDX);
	end
end
...
function ttd_passStage(nStage,strBossName)
	...
	local get_fix_award = function(nCurStage)
		local tAward = tbNormalAward
		if get_open_type() == tbJZMY.open_type_hard then
			tAward = tbNormalAwardHard
		end
    	...
    	local tAddRate = {
    		nExpAddRate = (1 + nBongLaiAddRate +nRouteAddRate+GetVipCardParam())*(1 + WJZ_EXP_ADD_RATE),
    	}
    	gf_EventGiveAllAward(tAward[nCurStage].tbAward,"V¹n KiÕm Tròng",format("WanJianZhong stage award %d",nCurStage),tAddRate);
	end
	...
	if nStage == 4 then
		...
		SetNpcScript(nNpcIndex,"\\script\\missions\\cangjianshanzhuang\\head.lua");
	else
...
--	ttd_GiveAward(nStage,tRequire);
	...
	_stat_when_pass_stage(nStage)
	
	this.msCamp:turnPlayer(0,ht_GetTongChip,20,1);
	FireEvent("event_mission_stage_finish", "wanjianzhong", nStage)
	TriggerTeamMisEvent("event_mission_passstage", "V¹n KiÕm Tròng", nStage);
end
...
function ttd_OpenUi(nStage,tRequire)
	...
	MA_Mission_OpenUI(tbJZMY.missionID,0,"\\script\\missions\\cangjianshanzhuang\\head.lua", szFunc, tRequire);
end
...
function _ttd_CallBack_Stage(nStage, nId)
	...
	local tAward = t_award
	if get_open_type() == tbJZMY.open_type_hard then
		tAward = t_award_hard
	end
	local nRet = MissionAward_RandAward(nStage, nId, tAward, _ib_item_stat);
...
--	print("GetMissionV(mv23) =",nNpcIndex);
	...
	FireEvent("event_mission_box_award", "wanjianzhong", "gold", nStage)
end
