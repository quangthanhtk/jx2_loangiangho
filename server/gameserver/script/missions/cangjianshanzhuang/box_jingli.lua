...
function main()
	--SendScript2VM("\\script\\missions\\cangjianshanzhuang\\mission.lua", format("jingli_box_main()"))
...
--        	end
--        	SetNpcScript(npc, "\\script\\missions\\cangjianshanzhuang\\box_jingli.lua");
--    	else
...
tJingLiAward = {
	...
	{1, 400, "Cöu ChuyÓn Hoµn Hån §an", {1, 0, 32, 1, 4}, 0},
}
