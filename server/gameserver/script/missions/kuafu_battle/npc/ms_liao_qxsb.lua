...
function main()
	...
	if KF_MS_STATE_PEACE == nState or KF_MS_STATE_READY == nState then
		...
		local szTitle="<color=green>Li™u Ti“n Tuy’n Binh<color>".." cﬂn "..tostring(KF_READY_TIME/18*nLoop).."s, chi’n tr≠Íng li™n Æ u ch›nh th¯c bæt Æ«u. SË ng≠Íi hi÷n tπi lµ: "..KF_CampOne_Name.."["..nPlayerOne.."]:"..KF_CampTwo_Name.."["..nPlayerTwo.."]"
		Say(szTitle, 0);
	else
		if KF_MS_STATE_COMPLETE ~= nState and GetFightState() == 0 then
			...
			local tTemp = {
				KF_MV_BATTLE_FLAG_JM, --’Û∆Ï0÷–¡¢£¨1ÀŒ£¨2¡…
				KF_MV_BATTLE_FLAG_MM, --’Û∆Ï0÷–¡¢£¨1ÀŒ£¨2¡…
				KF_MV_BATTLE_FLAG_SM,	--’Û∆Ï0÷–¡¢£¨1ÀŒ£¨2¡…
				KF_MV_BATTLE_FLAG_SI,	--’Û∆Ï0÷–¡¢£¨1ÀŒ£¨2¡…
				KF_MV_BATTLE_FLAG_DA,	--’Û∆Ï0÷–¡¢£¨1ÀŒ£¨2¡…
			}
			...
			local nPointIndex = GetMissionV(KF_MV_BATTLE_TEMP_SAFE_POS_INDEX_LIAO);
