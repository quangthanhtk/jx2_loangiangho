...
function slt_tong_box(npcIndex, nType)
	...
	FireEvent("event_mission_box_award", "siling", "copper", nType)
end
...
function slt_IamDaye(npcIdx)
	...
	if DelItem(SLT_OPEN_NEED[2],SLT_OPEN_NEED[3],SLT_OPEN_NEED[4],SLT_OPEN_NEED[5]) == 1 then
		...
		FireEvent("event_ib_cost", SLT_OPEN_NEED[2],SLT_OPEN_NEED[3],SLT_OPEN_NEED[4],SLT_OPEN_NEED[5])
		...
		FireEvent("event_mission_box_award", "siling", "silver", 0)
	else
...
function slt_jin_box(npcIndex)
	...
	FireEvent("event_mission_box_award", "siling", "gold", 0)
	--10Ãë½áÊø
	gf_TeamOperateEX(function ()
