...
Import("\\script\\missions\\kuafu_boss\\dacaoyuan1\\mission_head.lua")

Include("\\settings\\static_script\\missions\\base\\missionbase.lua")
Include("\\script\\missions\\kuafu_boss\\dacaoyuan1\\phase.lua")
...
Mission_Kfb.msOption.OnPlayerJoin = function(self, nCamp)
	...
	kfb_DataModifyTongMemberCountInMs(KFB_MS_TYPE, gf_GetRealmTongName(), 1)
end
