...
function ChiTonNew_MatTichMonPhai70(nQty)
	local tbMatTich = {
		...
		[25] = {item={{gdp={0,107,219, nQty}, name="Cöu Thiªn Phong L«i Ch©n QuyÓn"}}},
		[26] = {item={{gdp={0,107,220, nQty}, name="Cöu Thiªn Phong L«i Ch©n QuyÓn"}}},
		[27] = {item={{gdp={0,107,221, nQty}, name="Cöu Thiªn Phong L«i Ch©n QuyÓn"}}},
