...
function CTVL_getHN(nOption)
	...
	local tbVuKhiHaoNguyet_ctvl = {
		...
		[25] = {item={{gdp={0,2,8987,1,1,-1,-1,-1,-1,-1,-1,-1,11}, name = "H¹o NguyÖt-BÊt §éng Ch©n Tiªn KiÕm"}}},
		[26] = {item={{gdp={0,2,8988,1,1,-1,-1,-1,-1,-1,-1,-1,11}, name = "H¹o NguyÖt-BÊt §éng Ch©n Tiªn KiÕm"}}},
		[27] = {item={{gdp={0,2,8989,1,1,-1,-1,-1,-1,-1,-1,-1,11}, name = "H¹o NguyÖt-BÊt §éng Ch©n Tiªn KiÕm"}}},
