...
function OnPutinComplete(param)
	...
	-------------------- Check material ----------------------------
	local tbMaterial = {
		[1] = {item={{gdp={2,1,1006,11}}, {gdp={2,1,504,6}}}, task={{707, 30000, "TÝch lòy chiÕn tr­êng"}}},
	}
	...
	local nLevel = 0
	if GetEquipAttr(tbUpgradeList[1][1],2) >= 7  and GetEquipAttr(tbUpgradeList[1][1],2) < 12 then
		nLevel = 7;	
	end
	
	if GetEquipAttr(tbUpgradeList[1][1],2) >= 12 then
		nLevel = 10;	
	end
