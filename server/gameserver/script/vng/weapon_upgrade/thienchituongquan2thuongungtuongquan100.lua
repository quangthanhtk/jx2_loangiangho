...
function OnPutinComplete(param)
	...
	-------------------- Check material ----------------------------
	local tbMaterial = {
		[1] = {item={{gdp={2,1,1006,2}, name="Cöu Thiªn V« Cùc"}, {gdp={2,1,504,2}, name="N÷ Oa Tinh Th¹ch"}}},
		[2] = {item={{gdp={2,1,1006,2}, name="Cöu Thiªn V« Cùc"}, {gdp={2,1,504,2}, name="N÷ Oa Tinh Th¹ch"}}},
	}
