...
--====Sinh Tö V« Ng· lÇn 3
tbSTVN3config1 = { --TaskID, mission name, mission qty, TaskPosStart, TaskPosEnd
	[1] = {TSK_SINHTULAN3A092015, "trång c©y Tø Linh", 35,4,2},
	[2] = {TSK_SINHTULAN3A092015, "trång c©y B¸t Nh· nhá", 35,7,5},
	[3] = {TSK_SINHTULAN3A092015, "trång h¹t gièng", 28,9,8},
	[4] = {TSK_SINHTULAN3B092015, "Ng«i sao may m¾n", 35,2,1},
	[5] = {TSK_SINHTULAN3B092015, "N÷ oa b¶o h¹p", 120,5,3},
	[6] = {TSK_SINHTULAN3B092015, "L­¬ng S¬n B¹c", 3,6,6},
	[7] = {TSK_SINHTULAN3B092015, "Thiªn M«n TrËn", 4,8,7},
}
tbSTVN3config2 = { --TaskID, mission name, mission qty, TaskPosStart, TaskPosEnd
	[1] = {TSK_SINHTULAN3A092015, "Trång c©y Tø Linh", 113,4,2},
	[2] = {TSK_SINHTULAN3A092015, "Trång c©y B¸t Nh· nhá", 113,7,5},
	[3] = {TSK_SINHTULAN3A092015, "Trång h¹t gièng", 99,9,8},
	[4] = {TSK_SINHTULAN3B092015, "Ng«i sao may m¾n", 99,2,1},
	[5] = {TSK_SINHTULAN3B092015, "N÷ oa b¶o h¹p", 850,5,3},
	[6] = {TSK_SINHTULAN3B092015, "L­¬ng S¬n B¹c", 9,6,6},
	[7] = {TSK_SINHTULAN3B092015, "Thiªn M«n TrËn", 15,8,7},
	[8] = {TSK_SINHTULAN3B092015, "Tµi Nguyªn ChiÕn", 10,10,9},
	[9] = {TSK_SINHTULAN3C092015, "KÝch ho¹t b¸t nh· lín", 48,2,1},
--	[10] = {TSK_SINHTULAN3C092015, "Nép Cöu Thiªn V« Cùc §¬n ", 1,3,3},
--	[11] = {TSK_SINHTULAN3C092015, "Nép 20k bét m×", 1,4,4},
--	[12] = {TSK_SINHTULAN3C092015, "Nép 20k nh©n b¸nh", 1,5,5},
--	[13] = {TSK_SINHTULAN3C092015, "Nép 20k nh©n b¸nh ®Æc biÖt", 1,6,6},
--	[10] = {TSK_SINHTULAN3C092015, "§Þa huyÒn cung", 9,7,7},
	[10] = {TSK_SINHTULAN3C092015, "B¶o VÖ thµnh tr×", 7,8,8},
	[11] = {TSK_SINHTULAN3C092015, "Nh¹n M«n quan", 7,9,9},
}