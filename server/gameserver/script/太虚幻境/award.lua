...
function UseAllGetAward_new()
	...
	local nExpAward = 10000000;
	local nHonorAward = tbAward.nQuancong;
	local nPointAward = 0;
	...
	if LIB_Award:Award(tbAward) == 1 then
		...
		WPlayerLog:WriteBattleLog(g_WCFG_THAIHU1.szKey, "§æi bé b¸t qu¸i", 0, "", nExpBefore, nExpAward, nHonorBefore, nHonorAward, nPointBefore, nPointAward);
	end
end
