...
function wjz_daily_task()
	...
	if nTaskID == 0 then
		...
		elseif nRet == -3 then
			...
			FireEvent("event_mission_task_award", "wanjianzhong", "1daily_pass", 1)
		end
	end
end
...
function wjz_week_task()
	...
	if nTaskID == 0 then
		...
		elseif nRet == -3 then
			...
			FireEvent("event_mission_task_award", "wanjianzhong", "3weekly_pass", 3)
		end	
	end
end
...
function fanpai_daily_task()
	...
	if nTaskID == 0 then
		...
		elseif nRet == -3 then
			...
			FireEvent("event_mission_task_award", "wanjianzhong", "2daily_fanpai", 2)
		end		
	end
end
...
function fanpai_week_task()
	...
	if nTaskID == 0 then
		...
		elseif nRet == -3 then
			...
			FireEvent("event_mission_task_award", "wanjianzhong", "4weekly_fanpai", 4)
		end	
	end
end
