...
msOption = {
	...
	szInitReviveScript = "",--³õÊ¼¸´»î½Å±¾£¨½øÈëMissionÊ±µÄ¸´»î½Å±¾£©
	...
	szRestoreReviveScript = "",	--Àë¿ªMissionÊ±Òª¹ÒµÄ¸´»î½Å±¾
...
--	CreateTrigger(3,self.tbLogTrigger.nID,self.tbLogTrigger.nCustomID);	--´´½¨µÇÂ½´¥·¢Æ÷
	...
	SetPlayerReviveScript(self.szInitReviveScript);	--¸´»î½Å±¾
	ForbidChangePK(0);
...
--	RemoveTrigger(GetTrigger(msOption.tbLogTrigger.nCustomID));	--É¾³ıµÇÂ½´¥·¢Æ÷
	...
	SetPlayerReviveScript(self.szRestoreReviveScript); --¸´»î½Å±¾
