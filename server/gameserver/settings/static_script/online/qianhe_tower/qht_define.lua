...
--ÈÎÎñ±äÁ¿
QHT_TASK_VERSION = 3390;
QHT_TASK_IBSHOP_BEGIN = 3391;
QHT_TASK_IBSHOP_END = 3402;
...
QHT_MAPTEMPTASK_GOLDBOSS_MAX = 2;  --±äÁ¿
...
--Ìì½¾ÁîÃ¿Ìì²ú³öÊýÁ¿¼ÇÂ¼
QHT_MAPTEMPTASK_TIANJIAO_MAX = 6;

QHT_MAPTEMPTASK_HEIBAO_MAX = 7;  --ºÚ±ª²ú³öÉÏÏÞ±äÁ¿

QHT_MAPTEMPTASK_HUANGBAO_MAX = 8;--»Æ±ª²ú³öÉÏÏÞ±äÁ¿
--Ã¿ÈÕ²ú³öÉÏÏÞÖµ
QHT_TIANGANG_MAX = 1;
QHT_YJZUOJI_MAX = 0;
QHT_TIANMEN_MAX = 1;
