...
tGiveItemList = {
	...
	{{1,0,30008,99}, "Ng­ng Háa §¬n",25},
	{{1,0,30012,999}, "Linh Chi Tôc MÖnh Hoµn", 0},
	{{1,0,30013,999}, "Dao Tr× §¹i Hoµn §¬n", 0},
	{{1,0,30014,999}, "TuyÕt S©m Ph¶n KhÝ Hoµn", 0},
	{{1,1,30015,999}, "Linh Chi Tôc MÖnh Hoµn", 0},
	{{1,1,30016,999}, "Dao Tr× §¹i Hoµn §¬n", 0},
	{{1,1,30017,999}, "TuyÕt S©m Ph¶n KhÝ Hoµn", 0},
};
