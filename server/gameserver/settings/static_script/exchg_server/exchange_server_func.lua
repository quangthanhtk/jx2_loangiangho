...
-- TSK_KF_EMPLACEMENT_RESULT 	= 3275	-- ¿ç·şÅÚÌ¨Õ½Ê¤¸º½á¹û
-- KF_TASKID_PERSONAL_RANK 	= 3582	-- ¿ç·şÅÚÌ¨Õ½¸öÈË»îÔ¾¶ÈÅÅÃû
-- TSK_EMPLACEMENT_SIGN 		= 3586	-- ¿ç·şÅÚÌ¨Õ½¿ªÆôÇ©Ãû£¬ÓĞÇ©ÃûÕß¿ÉÒÔ·µ»ØÕ½³¡
-- TSK_LAST_JOIN_CAMP 			= 3588	-- ¿ç·şÅÚÌ¨Õ½µÄÈÕÆÚºÍÕóÓª£¬ÓÃÓÚ·µ»ØÕ½³¡
-- TSK_KF_EMPLACEMENT_ACTIVITY_TO_SOURCE = 3589 	-- ¿ç·şÅÚÌ¨Õ½´«»ØÔ­·şµÄµ¥³¡»îÔ¾¶ÈÊı¾İ

-- TSK_KF_MAINBATTLE_RESULT 			= 3644 -- ¿ç·şÑãÃÅ¹ØÊ¤¸º½á¹û
-- TSK_KF_MAINBATTLE_PERSONAL_RANK 	= 3645 -- ¿ç·şÑãÃÅ¹Ø¸öÈË»îÔ¾¶ÈÅÅÃû
-- TSK_KF_MAINBATTLE_SIGN 				= 3639 -- ¿ç·şÑãÃÅ¹ØÈë³¡Ê±¼äÇ©Ãû£¬ÓĞÇ©ÃûÕß¿ÉÒÔ·µ»ØÕ½³¡
-- TSK_KF_MAINBATTLE_LAST_JOIN_CAMP 	= 3641 -- ¿ç·şÑãÃÅ¹ØµÄÈÕÆÚºÍÕóÓª£¬ÓÃÓÚ·µ»ØÕ½³¡
-- TSK_KF_MAINBATTLE_ACTIVITY_TO_SOURCE = 3642 -- ¿ç·şÑãÃÅ¹Ø´«»ØÔ­·şµÄµ¥³¡»îÔ¾¶ÈÊı¾İ
...
t_auto_sync_task_group = 
{
	...
	{{3275, 3276, 3277, 3582, 3586, 3587, 3588, 3589}, 0, nil}, --¿ç·şÅÚÌ¨Õ½½á¹û£¬¸öÈË»ı·ÖºÍ»ı·Ö½±Àø
	{{3368, 3369, 3370, 3371, 3372, 3373, 3378}, 37, nil}, --»î¶¯¿¨
	{{701, 3500, 3501, 3502, 3503, 3504, 3505, 3533}, 0,nil},-- Õ½³¡Õ¼¿Ó
	{{3506, 3507, 3508, 3509}, 0, nil},	-- ÏÁÂ·Ïà·ê´«»Ø
	{{3524,3525,3526,3527, }, 0, nil},	-- »¯¾³ÈÎÎñ ¿ç·şÕ½³¡´«»Ø
	{{3593, }, 0, nil},	-- ¿ç·şbossÕ½ ¸öÈË»îÔ¾
	{{3639, 3641, 3642, 3644, 3645, }, 0, nil},	-- ¿ç·şÑãÃÅ¹ØÖ÷Õ½³¡
...
function on_kuafu_task_synced(nGroupId)
	...
	if 5 == nGroupId then
		...
		SendScript2VM("\\script\\isolate\\functions\\tong_extension\\main.lua", "TongExt_3v3_Award()");
		-- TongExt_3v3_Award()
	end
	if 7 == nGroupId then
		SendScript2VM("\\script\\isolate\\functions\\tong_extension\\main.lua", "TongExt_1v1_Award()");
		-- TongExt_1v1_Award()
	end
	if 13 == nGroupId then
...
t_kuafu_guide_npc_pos_gs={
	{300, 1850, 3550, "Vâ L©m Minh Chñ1", "Quan tiÕp dÉn Liªn §Êu", "\\script\\exchg_server\\exchg_server_npc.lua"},
	{100, 1344, 2939, "Vâ L©m Minh Chñ1", "Quan tiÕp dÉn Liªn §Êu", "\\script\\exchg_server\\exchg_server_npc.lua"},
	{150, 1775, 3119, "Vâ L©m Minh Chñ1", "Quan tiÕp dÉn Liªn §Êu", "\\script\\exchg_server\\exchg_server_npc.lua"},
	{350, 1606, 2937, "Vâ L©m Minh Chñ1", "Quan tiÕp dÉn Liªn §Êu", "\\script\\exchg_server\\exchg_server_npc.lua"},
}
--¿ç·şÁì½±ÈË
...
t_kuafu_guide_npc_pos_ggs = {
	{8899, 1290, 2693, "Vâ L©m Minh Chñ1", "Quan tiÕp dÉn Liªn §Êu", "\\script\\exchg_server\\exchg_server_npc.lua"},
	{8899, 1431, 2809, "Vâ L©m Minh Chñ1", "Quan tiÕp dÉn Liªn §Êu", "\\script\\exchg_server\\exchg_server_npc.lua"},
	{8899, 1512, 2720, "Vâ L©m Minh Chñ1", "Quan tiÕp dÉn Liªn §Êu", "\\script\\exchg_server\\exchg_server_npc.lua"},
	{8899, 1347, 2592, "Vâ L©m Minh Chñ1", "Quan tiÕp dÉn Liªn §Êu", "\\script\\exchg_server\\exchg_server_npc.lua"},
}
--¿ç·ş±¨ÃûÈË1
...
t_kuafu_one_road_battle_npc = {
	{8899, 1301, 2679, "Tèng T­íng Qu©n", "HiÖp Lé Tham T­íng", "\\script\\exchg_server\\one_road_battle_npc.lua"},
	{8899, 1395, 2788, "Tèng T­íng Qu©n", "HiÖp Lé Tham T­íng", "\\script\\exchg_server\\one_road_battle_npc.lua"},
	{8899, 1505, 2754, "Tèng T­íng Qu©n", "HiÖp Lé Tham T­íng", "\\script\\exchg_server\\one_road_battle_npc.lua"},
	{8899, 1377, 2617, "Tèng T­íng Qu©n", "HiÖp Lé Tham T­íng", "\\script\\exchg_server\\one_road_battle_npc.lua"},

	{8908, 1467, 2998, "Tèng T­íng Qu©n", "HiÖp Lé Tham T­íng", "\\script\\exchg_server\\one_road_battle_npc.lua"},
	{8909, 1467, 2998, "Tèng T­íng Qu©n", "HiÖp Lé Tham T­íng", "\\script\\exchg_server\\one_road_battle_npc.lua"},
	{8910, 1467, 2998, "Tèng T­íng Qu©n", "HiÖp Lé Tham T­íng", "\\script\\exchg_server\\one_road_battle_npc.lua"},
}
...
function _kf_create_npc_server_start()
	...
	if at_ggs == 0 then
		...
		_kf_create_npc_list(t_kuafu_one_road_battle_npc)
	end
end

function _check_to_kuafu_condition()
	local nTransLevel = gf_GetPlayerRebornCount() * 100 + GetLevel()
	if nTransLevel < 580 or GetPlayerRoute() == 0 then
		Talk(1, "", format("%d chuyÓn cÊp %d trë lªn vµ ®· gia nhËp l­u ph¸i míi cã thÓ vµo m¸y chñ liªn sever", 5, 80))
		return 0;
	end
