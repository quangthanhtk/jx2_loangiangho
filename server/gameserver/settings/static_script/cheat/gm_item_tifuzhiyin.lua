...
function join_wd()
	...
	local szSay = {
		g_szTitle.."Ng­¬i muèn gia nhËp l­u ph¸i g×?",
		"Vâ §ang KiÕm/#enter_mp(14)",
		"Vâ §ang Bót/#enter_mp(15)",
		"Ra khái/nothing",
	};
...
function join_gb()
	...
	local szSay = {
		g_szTitle.."Ng­¬i muèn gia nhËp l­u ph¸i g×?",
		"C¸i Bang QuyÒn/#enter_mp(11)",
		"C¸i Bang Bæng/#enter_mp(12)",
		"Ra khái/nothing",
	};
	SelectSay(szSay);
end;
...
function join_ym()
	...
	local szSay = {
		g_szTitle.."Ng­¬i muèn gia nhËp l­u ph¸i g×?",
		"D­¬ng Gia Th­¬ng/#enter_mp(17)",
		"D­¬ng Gia Cung/#enter_mp(18)",
		"Ra khái/nothing",
	};
	SelectSay(szSay);
end;
...
function join_mj()
	...
	local szSay = {
		...
		format("%s/#enter_mp(25)", "Th¸nh ChiÕn"),
		format("%s/#enter_mp(26)", "TrËn Binh"),
		format("%s/#enter_mp(27)", "HuyÕt Nh©n"),
		"Ra khái/nothing",
	}
	SelectSay(szSay);
end;
...
function Get_Gem()
	...
	WriteLogEx("Get_Gem","NhËn ®¸ quý", 100, "HuyÕt TrÝch Th¹ch Lv5");
	AddItem(2, 22, 201, 100);
	WriteLogEx("Get_Gem","NhËn ®¸ quý", 100, "NguyÖt B¹ch Th¹ch Lv5");
