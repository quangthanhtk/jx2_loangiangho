...
--===================================================================================
SUB_BATTLE_MAX_PLAYER = 100        --¸±Õ½³¡µ¥·½ÈËÊýÉÏÏÞ
MAIN_BATTLE_MAX_PLAYER = 300    --Ö÷Õ½³¡µ¥·½ÈËÊýÉÏÏÞ
...
MAIN_BATTLE_SIGNUP_MAX_PLAYER = 300    --Ö÷Õ½³¡±¨Ãûµ¥·½ÈËÊýÉÏÏÞ
...
PT_LAST_RESULT_KF = 2575--10;			--¼ÇÂ¼Íæ¼Ò²Î¼ÓµÄÉÏÒ»³¡Õ½³¡µÄ½á¹û
...
PT_POINT_AWARD_KF = 2576--54;			--¼ÇÂ¼Ëù»ñµÃµÄ»ý·Ö½±Àø	
...
PTNC_ACTIVITY_KF = 2887                --µ¥³¡Õ½³¡»îÔ¾ÏµÊý
PTNC_BATTLEPOINT_KF = 2577--84		--µ¥³¡Õ½ÒÛµÄ»ý·Ö
...
-----------------ÅÚÌ¨Õ½------------------
TSK_KF_EMPLACEMENT_RESULT = PT_LAST_RESULT_KF + BATTLE_OFFSET --3275 -- ¿ç·þÅÚÌ¨Õ½³¡Ê¤¸º½á¹û
KF_TASKID_PERSONAL_RANK = 3582    -- ¿ç·þÅÚÌ¨Õ½¸öÈË»îÔ¾¶ÈÅÅÃû
TSK_EMPLACEMENT_SIGN = 3586    -- ¿ç·þÅÚÌ¨Õ½¿ªÆôÇ©Ãû£¬ÓÐÇ©ÃûÕß¿ÉÒÔ·µ»ØÕ½³¡
TSK_LAST_JOIN_CAMP = 3588    -- ¿ç·þÅÚÌ¨Õ½µÄÕóÓª£¬ÓÃÓÚ·µ»ØÕ½³¡
TSK_KF_EMPLACEMENT_ACTIVITY_TO_SOURCE = 3589    -- ¿ç·þÅÚÌ¨Õ½´«»ØÔ­·þµÄµ¥³¡»îÔ¾¶ÈÊý¾Ý

-----------------Ö÷Õ½³¡------------------
TSK_KF_MAINBATTLE_RESULT = 3644 -- ¿ç·þÑãÃÅ¹ØÊ¤¸º½á¹û
TSK_KF_MAINBATTLE_PERSONAL_RANK = 3645 -- ¿ç·þÑãÃÅ¹Ø¸öÈË»îÔ¾¶ÈÅÅÃû
TSK_KF_MAINBATTLE_SIGN = 3639 -- ¿ç·þÑãÃÅ¹ØÈë³¡Ê±¼äÇ©Ãû£¬ÓÐÇ©ÃûÕß¿ÉÒÔ·µ»ØÕ½³¡
TSK_KF_MAINBATTLE_LAST_JOIN_CAMP = 3641 -- ¿ç·þÑãÃÅ¹ØµÄÈÕÆÚºÍÕóÓª£¬ÓÃÓÚ·µ»ØÕ½³¡
TSK_KF_MAINBATTLE_ACTIVITY_TO_SOURCE = 3642 -- ¿ç·þÑãÃÅ¹Ø´«»ØÔ­·þµÄµ¥³¡»îÔ¾¶ÈÊý¾Ý

TSK_KF_MAINBATTLE_PLAYER_DEATH_POINT = 3643 -- ¿ç·þÑãÃÅ¹ØÃ¿³¡ËÀÍö»ñµÃµÄ»ý·Ö Áì½±Ê±Çå0
-- TSK_KF_MAINBATTLE_ACTIVITY			 = 3646 -- »ý·Ö½±Àø

N_KF_MAX_MAINBATTLE_PLAYER_DEATH_POINT = 20

-----------------ÓÃÓÚ½Ó¿ÚÍ³Ò»-------------
--Ô­·þÁì½±¸öÈË»ý·ÖÒªÇó
T_TSK_KF_AWARD_NEED_PERSONAL_POINT = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = 220,
    [MAINBATTLE_ID] = 30,
}
--ÅÅÃû½±ÀøµÄÅÅÃûÒªÇó
T_TSK_KF_RANK_AWARD_NEED_RANK = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = 3,
    [MAINBATTLE_ID] = 10,
...
--¸öÈË»ý·ÖÅÅÃûTaskID
T_TSK_KF_PERSONAL_RANK = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = KF_TASKID_PERSONAL_RANK,
    [MAINBATTLE_ID] = TSK_KF_MAINBATTLE_PERSONAL_RANK,
}
--Õ½³¡Ê¤¸ºÆ½½á¹û
T_TSK_KF_BATTLE_RESULT = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = TSK_KF_EMPLACEMENT_RESULT,
    [MAINBATTLE_ID] = TSK_KF_MAINBATTLE_RESULT,
}

--±¨ÃûÇ©Ãû±ê¼Ç±äÁ¿ ÓÃÓÚ·µ³¡
T_TSK_KF_SIGN_FLAG = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = TSK_EMPLACEMENT_SIGN,
    [MAINBATTLE_ID] = TSK_KF_MAINBATTLE_SIGN,
}
--ÉÏ´Î²ÎÓëµÄÊ±¼äºÍÕóÓª±äÁ¿
T_TSK_KF_LASTCAMP = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = TSK_LAST_JOIN_CAMP,
    [MAINBATTLE_ID] = TSK_KF_MAINBATTLE_LAST_JOIN_CAMP,
}
--»îÔ¾¶È±äÁ¿ ´«»ØÔ­·þ
T_TSK_KF_ACTIVITY_TO_SOURCE = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = TSK_KF_EMPLACEMENT_ACTIVITY_TO_SOURCE,
    [MAINBATTLE_ID] = TSK_KF_MAINBATTLE_ACTIVITY_TO_SOURCE,
}
--²Î¼ÓµÈ¼¶ÒªÇó
T_KF_JOIN_NEED_TRANSLEVEL = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = 992,
    [MAINBATTLE_ID] = 1090,
...
--²Î¼Ó¾ü¹¦ÒªÇó
T_KF_JOIN_NEED_JUNGONG = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = 120000,
    [MAINBATTLE_ID] = 120000,
}
--±¨ÃûÍ­±ÒÏûºÄ
T_KF_JOIN_CASH_COST = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = 200000,
    [MAINBATTLE_ID] = 300000,
}
--²¹±¨ÃûÍ­±ÒÏûºÄ
T_KF_JOIN_SUPPLEMENTARY_CASH_COST = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = 3000000,
    [MAINBATTLE_ID] = 3000000,
}
--Ë«·½ÈËÊý²îÉÏÏÞ
T_KF_MAX_SIGNUP_PLAYER_DIFF = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = SUB_BATTLE_SIGNUP_PLAYER_DIFF,
    [MAINBATTLE_ID] = MAIN_BATTLE_SIGNUP_PLAYER_DIFF,
}
--µ¥·½ÈËÊýÉÏÏÞ
T_KF_BATTLE_MAX_PLAYER = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = SUB_BATTLE_MAX_PLAYER,
    [MAINBATTLE_ID] = MAIN_BATTLE_MAX_PLAYER,
}
--Èë³¡Âñµã
T_KF_BATTLE_RUNTIMESTATE_JOIN = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = { 76, 1 },
    [MAINBATTLE_ID] = { 109, 1 },
...
T_KF_BATTLE_STATE = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = { state_sign = 1, state_fighting = 2 }, --{open, fighting}
    [MAINBATTLE_ID] = { state_sign = 3, state_fighting = 4 }, --{open, fighting}
}
...
--Õ½³¡½±Àø
T_KF_BATTLE_AWARD_INFO = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = {
        [WIN] = {
            tJunGong = { 2400, 4800, 12000, 24000, 33600 },
            exp = 800000000,
            coin = 1000000,
            item = {
                { 2, 1, 31233, 2, 4, "PhiÕu §æi Ngo¹i Trang" },
                { 2, 1, 31244, 4, 4, "M¶nh C¬ Quan MÆc Gia" },
            },
            nNeedRoom = 3,
            tRuntimeStat = { { 76, 3 }, { 76, 4 }, { 76, 5 }, { 76, 6 }, { 76, 7 } },
            szLogCaption = "KFBattleAwardEmplacementWin",
        },
        [LOSE] = {
            tJunGong = { 1600, 3200, 8000, 16000, 22400 },
            exp = 400000000,
            coin = 0,
            item = {
                { 2, 1, 31233, 1, 4, "PhiÕu §æi Ngo¹i Trang" },
                { 2, 1, 31244, 2, 4, "M¶nh C¬ Quan MÆc Gia" },
            },
            nNeedRoom = 3,
            tRuntimeStat = { { 76, 8 }, { 76, 9 }, { 76, 10 }, { 76, 11 }, { 76, 12 } },
            szLogCaption = "KFBattleAwardEmplacementLose",
        },
        [DEUCE] = {
            tJunGong = { 1600, 3200, 8000, 16000, 22400 },
            exp = 400000000,
    ...
    [MAINBATTLE_ID] = {
        [WIN] = {
            tJunGong = { 3000, 6000, 15000, 30000, 42000 },
            exp = 1000000000,
            coin = 0,
            tAwardGroup = { "kfymg_win", 0 },
            nNeedRoom = 4,
            szLogCaption = "KFBattleAwardMainbattleWin",
        },
        [LOSE] = {
            tJunGong = { 2000, 4000, 10000, 20000, 28000 },
            exp = 500000000,
            coin = 0,
            tAwardGroup = { "kfymg_failure", 0 },
            nNeedRoom = 4,
            szLogCaption = "KFBattleAwardMainbattleLose",
        },
        [DEUCE] = {
            tJunGong = { 2000, 4000, 10000, 20000, 28000 },
            exp = 500000000,
...
--¾ü¹¦¡¢¾­ÑéÅÅÃû¿¿Ç°µÄ±¶ÂÊ
T_KF_BATTLE_EXP_JUNGONG_AWARD_MUL = {
    --[VILLAGE_ID] = "ÑãÃÅ¹Ø´åÂäÕ½ÒÛ",
    --[RESOURCE_ID] = "ÑãÃÅ¹Ø²Ý¹È³¡Õ½ÒÛ",
    [EMPLACEMENT_ID] = 1.2,
    [MAINBATTLE_ID] = 1.2,
