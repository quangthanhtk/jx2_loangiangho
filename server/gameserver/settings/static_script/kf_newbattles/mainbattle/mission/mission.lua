...
-- ¿ªÆôÊ±Ç©¸öÃû£¬ÓÐ±¾³¡Ç©ÃûµÄÍæ¼Ò¿ÉÒÔ»Øµ½Õ½³¡
function mainbattle_sign_in()
	-- ¼ÇÏÂÊ±¼ä´Áµ±Ç©Ãû
	SetTask(TSK_KF_MAINBATTLE_SIGN, GetTime())
end

function RunMission()
	Msg2MSAll(MISSION_ID,"Th¸m tö håi b¸o, ®Þch ph­¬ng ®· hµnh ®éng, t­íng sÜ phe ta nhanh chãng vµo trong chuÈn bÞ t¸c chiÕn.");
	
	BT_OperateAllPlayer(mainbattle_sign_in, {}, ALL_ID);
...
function JoinMission(RoleIndex,nCamp)
	...
	SetTask(TSK_KF_MAINBATTLE_LAST_JOIN_CAMP, date*10 + nCamp)
	PlayerIndex = RoleIndex;
end;