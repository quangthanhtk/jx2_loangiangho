...
function tell_end(param)
	...
	local szMsg = tBattleName[BATTLE_TYPE].."®· kÕt thóc, <color=yellow>tÝch lòy c«ng céng phe Tèng:"..nPubPointSong..", tÝch lòy c«ng céng phe Liªu:"..nPubPointLiao..", "..szResult.."<color>."
	Say(szMsg..szRank,0);
