...
BATTLE_TYPE = MAINBATTLE_ID;	--Õ½³¡ÀàÐÍ
...
tNpcInfo = {									--NPCÃû×Ö¡¡¡¡Ä£°åÃû
	[TYPE_SOLDIER] = {tSoldierSong,tSoldierLiao,{{"Tèng qu©n tinh binh","Tinh Binh-Tèng (Liªn Server)"},{"Tèng qu©n c­êng nâ binh","C­êng Ná Binh-Tèng (Liªn Server)"}},{{"Liªu qu©n dòng sÜ","Dòng SÜ-Liªu (Liªn Server)"},{"Liªu qu©n ng¹nh tiÔn binh","Ng¹nh TiÔn Binh-Liªu (Liªn Server)"}}},
	[TYPE_ARROWBUILDING] = {tArrowBuildingSong,tArrowBuildingLiao,{{"TiÔn th¸p-Tèng","TiÔn Th¸p-Tèng (Liªn Server)"}},{{"TiÔn th¸p-Liªu","TiÔn Th¸p-Liªu (Liªn Server)"}}},
	[TYPE_LOOEY] = {tLooeySong,tLooeyLiao,{{"Tèng hiÖu óy","Tèng §« y (Liªn Server)"}},{{"Liªu hiÖu óy","Liªu §« y (Liªn Server)"}}},
	[TYPE_CAPTAIN] = {tCaptainSong,tCaptainLiao,{{"Tèng §« thèng","Tèng §« Thèng (Liªn Server)"}},{{"Liªu §« thèng","Liªu §« Thèng (Liªn Server)"}}},
	[TYPE_PIONEER] = {tPioneerSong,tPioneerLiao,{{"Tèng tiªn phong","Tèng Tiªn Phong (Liªn Server)"}},{{"Liªu tiªn phong","Liªu Tiªn Phong (Liªn Server)"}}},
	[TYPE_GENERAL] = {tGeneralSong,tGeneralLiao,{{"T­íng qu©n (Tèng)","Tèng T­íng Qu©n (Liªn Server)"}},{{"T­íng qu©n (Liªu) ","Liªu T­íng Qu©n (Liªn Server)"}}},
	[TYPE_MARSHAL] = {tMarshalSong,tMarshalLiao,{{"Tèng nguyªn so¸i","Tèng Nguyªn So¸i (Liªn Server)"}},{{"Liªu nguyªn so¸i","Liªu Nguyªn So¸i (Liªn Server)"}}},
	[TYPE_HEADER] = {tVillagerHeaderPos,tVillagerHeaderPos,{{"Thñ lÜnh thæ d©n","Thñ LÜnh Thæ D©n (Liªn Server)"}},{{"Thñ lÜnh thæ d©n","Thñ LÜnh Thæ D©n (Liªn Server)"}}},
	[TYPE_REFUGEE] = {tVillagerPos,tVillagerPos,{{"Thæ d©n","Thæ D©n (Liªn Server)"},{"Thæ d©n","Cung TiÔn Thñ-Thæ D©n (Liªn Server)"}},{{"Thæ d©n","Thæ D©n (Liªn Server)"},{"Thæ d©n","Cung TiÔn Thñ-Thæ D©n (Liªn Server)"}}},
	[TYPE_EMPLACEMENT] = {tEmplacementPos,tEmplacementPos,{{"Ph¸o ®µi","Háa Ph¸o Trung Qu©n (Liªn Server)"}},{{"Ph¸o ®µi","Háa Ph¸o Trung Qu©n (Liªn Server)"}}},
	[TYPE_HERO] = {tNonalignedHeroPos,tNonalignedHeroPos,{{"Kú nh©n dÞ sÜ","Vâ T­íng Trung LËp (Liªn Server)"}},{{"Kú nh©n dÞ sÜ","Vâ T­íng Trung LËp (Liªn Server)"}}},
}
T_REFUGEE_NPC_INFO = {--{NpcName,model1,model2}
	[SONG_ID] = {"N¹n d©n Tèng","N¹n D©n-Tèng (Liªn Server)","N¹n d©n-Tèng ®­îc cøu tho¸t"},
	[LIAO_ID] = {"N¹n d©n Liªu","N¹n D©n-Liªu (Liªn Server)","N¹n d©n-Liªu ®­îc cøu tho¸t"},
}
...
KF_N_CREAT_YUANSHUAI_NEED_MISSIONPOINT_MIN = 30000 --×îµÍ¶àÉÙÕóÓª»ý·Ö²ÅÄÜË¢¶Ô·½ÔªË§
...
function Create_Emplacement(nPosition,nCamp)
	...
	nNpcIndex = CreateNpc("Háa Ph¸o Trung Qu©n (Liªn Server)",sNpcName,MAPID,tEmplacementPos[nPosition][1],tEmplacementPos[nPosition][2]);
	SetCampToNpc(nNpcIndex,tCampNameP[nCamp]);
...
function Create_VillagerHeader(nCamp)
	if GetMissionV(MV_HEADER_DEATH) == 1 then
		for i=1,getn(tVillagerHeaderPos) do 
			local nNpcIndex = CreateNpc("Thñ LÜnh Thæ D©n (Liªn Server)","Thñ lÜnh thæ d©n",MAPID,tVillagerHeaderPos[i][1],tVillagerHeaderPos[i][2])
			SetNpcDeathScript(nNpcIndex,"\\settings\\static_script\\kf_newbattles\\mainbattle\\npc_death.lua");
			SetCampToNpc(nNpcIndex,tCampNameP[nCamp]);
		end;
...
function Create_Villager(nCamp)
	for i=1,getn(tVillagerPos) do 
		local nNpcIndex = CreateNpc("Thæ D©n (Liªn Server)","Thæ d©n",MAPID,tVillagerPos[i][1],tVillagerPos[i][2])
		SetNpcDeathScript(nNpcIndex,"\\settings\\static_script\\kf_newbattles\\mainbattle\\npc_death.lua");
		SetCampToNpc(nNpcIndex,tCampNameP[nCamp]);
	end;
end;
...
function Create_Random_Pos_Villager(nCamp,nCount)
	...
	for i=1,nCount do
		...
		local nNpcIndex = CreateNpc("Thæ D©n (Liªn Server)","Thæ d©n",MAPID,tVillagerPos[nRanPos][1],tVillagerPos[nRanPos][2],-1,1,1,100);
		SetNpcDeathScript(nNpcIndex,"\\settings\\static_script\\kf_newbattles\\mainbattle\\npc_death.lua");
		SetCampToNpc(nNpcIndex,tCampNameP[nCamp]);
	end;
...
function Create_Nonaligned_Hero()
	if GetMissionV(MV_HERO_DEATH) == 1 then
		for i=1,getn(tNonalignedHeroPos) do 
			local nNpcIndex = CreateNpc("Vâ t­íng trung lËp","Kú nh©n dÞ sÜ",MAPID,tNonalignedHeroPos[i][1],tNonalignedHeroPos[i][2])
			SetNpcDeathScript(nNpcIndex,"\\settings\\static_script\\kf_newbattles\\mainbattle\\npc_death.lua");
...
function Create_Refugee(nCamp,nCount)
	...
	for i=1,nCount do
		...
		nRefugeeIndex = CreateNpc(tRefugeeNpcInfo[2],tRefugeeNpcInfo[1],MAPID,tPos[nCampPlace][nRandPos][1],tPos[nCampPlace][nRandPos][2],-1,1,1,20);
...
function Create_ArrowBuilding()
	for i=1,ARROWBUILDING_COUNT do
		local nNpcIndex = CreateNpc("TiÔn Th¸p-Tèng (Liªn Server)","TiÔn th¸p",MAPID,tArrowBuildingSong[i][1],tArrowBuildingSong[i][2]);
		AddGroupUnit(ARROWBUILDING_GROUP_SONG,nNpcIndex);
	end;
	for i=1,ARROWBUILDING_COUNT do
		local nNpcIndex = CreateNpc("TiÔn Th¸p-Liªu (Liªn Server)","TiÔn th¸p",MAPID,tArrowBuildingLiao[i][1],tArrowBuildingLiao[i][2]);
...
function Judge_State_By_Point(nCamp)
	...
	if nEnemyNpcType == 0 and nMissionPoint >= nEnemyCount*100 then
		...
		if Try_To_Create_FightNPC("Tiªn phong",nEnemyCamp) ~= 0 then		--µÐ·½¹«¹²»ý·Ö³¬¹ýÒ»¶¨ÊýÖµ£º±¾·½×ÜÈËÊý*100£¬¶Ô·½ÏÈ·æ³ö
			if nPlayerCamp == SONG_ID then
				Msg2MSAll(MISSION_ID,"TÝch lòy phe Tèng v­ît qu¸ "..(nEnemyCount*100)..", buéc tiªn phong phe Liªu xuÊt hiÖn.");
			else
				Msg2MSAll(MISSION_ID,"TÝch lòy phe Liªu v­ît qu¸ "..(nEnemyCount*100)..", buéc tiªn phong phe Tèng xuÊt hiÖn.");
			end;
		end;
	elseif nEnemyNpcType == 1 and nMissionPoint >= nEnemyCount*200 then
		BT_ShowDebugInfor("LËp t­íng qu©n");
		if Try_To_Create_FightNPC("T­íng qu©n",nEnemyCamp) ~= 0 then	--µÐ·½¹«¹²»ý·Ö³¬¹ýÒ»¶¨ÊýÖµ£º±¾·½×ÜÈËÊý*200£¬¶Ô·½´ó½«³ö
			if nPlayerCamp == SONG_ID then
				Msg2MSAll(MISSION_ID,"TÝch lòy phe Tèng v­ît qu¸ "..(nEnemyCount*200)..", buéc ®¹i t­íng phe Liªu xuÊt hiÖn.");
			else
				Msg2MSAll(MISSION_ID,"TÝch lòy phe Liªu v­ît qu¸ "..(nEnemyCount*200)..", buéc ®¹i t­íng phe Tèng xuÊt hiÖn.");
			end;		
		end;
	elseif nEnemyNpcType == 2 and nMissionPoint >= max(nEnemyCount*400, KF_N_CREAT_YUANSHUAI_NEED_MISSIONPOINT_MIN) then
		BT_ShowDebugInfor("LËp nguyªn so¸i");
		if Try_To_Create_FightNPC("Nguyªn So¸i",nEnemyCamp) ~= 0 then	--µÐ·½¹«¹²»ý·Ö³¬¹ýÒ»¶¨ÊýÖµ£º±¾·½×ÜÈËÊý*400£¬¶Ô·½ÔªË§³ö
			if nPlayerCamp == SONG_ID then
				Msg2MSAll(MISSION_ID,"TÝch lòy phe Tèng v­ît qu¸ "..max(nEnemyCount*400, KF_N_CREAT_YUANSHUAI_NEED_MISSIONPOINT_MIN)..", buéc nguyªn so¸i phe Liªu xuÊt hiÖn.");
			else
				Msg2MSAll(MISSION_ID,"TÝch lòy phe Liªu v­ît qu¸ "..max(nEnemyCount*400, KF_N_CREAT_YUANSHUAI_NEED_MISSIONPOINT_MIN)..", buéc nguyªn so¸i phe Tèng xuÊt hiÖn.");
			end;		
		end;
	else
