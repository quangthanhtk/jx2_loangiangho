...
t_switch_config = {
    ...
    { SYS_SWITCH_KF_BATTLE, 0, "KuaFuBattle", "ChiÕn Tr­êng Liªn Server" },
    { SYS_SWITCH_3V3, 1, "3V3" },
    { SYS_SWITCH_TONGMELEE, 0, "TongMelee" },
    { SYS_SWITCH_CARD_VIP, 1, "CardVip" },
    { SYS_SWITCH_GEM_SYSTEM, 1, "GemSystem", "HÖ thèng §¸ Quý" },
    { SYS_SWITCH_TAIYI, 0, "TaiYi", "¶i PhÇn Thiªn L©m" },
    { SYS_SWITCH_STATE_CHESS, 0, "StateChess", "Tr­îng KiÕm Thiªn Nhai" },
    { SYS_SWITCH_MERIT, 0, "Merit", "C«ng tr¹ng vâ l©m vµ ®iÓm kiÕm hiÖp" },
    { SYS_SWITCH_EYT, 0, "eyt_battle", "Tû Vâ ¢n O¸n §µi" },
    { SYS_SWITCH_KF_NEWBATTLE, 0, "kf_newbattle", "Ph¸o §µi ChiÕn Liªn Server" },
    { SYS_SWITCH_HONOR_TONG, 0, "HonorTong", "Bang Héi Vinh Danh" },
    { 21, 0, "UnUse" },
    { 22, 0, "UnUse" },
    { 23, 0, "UnUse" },
    { 24, 0, "UnUse" },
