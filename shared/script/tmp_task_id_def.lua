...
TEMP_FIELD_PVP_READ_STATE = _TMP_TASK_ID_VEIT_BEGIN + 17; --Yp临时变量
TEMP_FIELD_PVP_CHOOSE_CAMP = _TMP_TASK_ID_VEIT_BEGIN + 18; --Yp临时变量
TEMP_FIELD_PVP_TREE_TYPE = _TMP_TASK_ID_VEIT_BEGIN + 19; --Yp临时变量
TEMP_FIELD_PVP_CHOOSE_GXD = _TMP_TASK_ID_VEIT_BEGIN + 20; --Yp临时变量
TEMP_FIELD_PVP_WLMCJS_IDX = _TMP_TASK_ID_VEIT_BEGIN + 21; --Yp临时变量
