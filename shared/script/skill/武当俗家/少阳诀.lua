...
SKILL = {
	...
	{
	{"skill_sub_skill1_probability",{{1,0},{2,0},{3,8},{4,10},{5,12},{6,20}}},
	{"skill_sub_skill1_factor",{{1,0},{2,0},{3,10},{4,13},{5,16},{6,20}}},
	},

	SKILL_LEVEL_COST_ATTRIB	  =	--技能等级相关消耗属性
	{
	{"cost_mana_point",{{1,12},{5,14},{6,14}}}
	},
	...
	{
	{magic="damage_life",
	damage_factor_c={{1,46},{6,124}},
	damage_factor_e={{1,78},{6,156}},
	damage_factor_x={{1,179},{6,257}},
