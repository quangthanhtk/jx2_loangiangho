...
SKILL = {
	...
	{
	{"skill_burst_time",{{1,14},{2,14},{3,24},{7,24}}},
	{"skill_nextskill_wait_time",{{1,8},{2,8},{3,10},{4,10},{5,12},{6,12},{7,14}}},
	...
	{
	{magic="damage_life",
	damage_factor_c={{1,33},{7,66}},
	damage_factor_e={{1,33},{7,66}},
	damage_factor_x={{1,71},{7,88}},
