...
SKILL = {
	...
	{
		{ magic = "damage_life",
		  --damage_factor_x = { { 1, 200 }, { 7, 350 } }, --goc ksgvn
		  damage_factor_x = { { 1, 230 }, { 7, 522 } }, --chinh theo vng
		...
		{ magic = "damage_attack_enemy_def_add",
		  --damage_factor_z = { { 1, 1 }, { 2, 2 }, { 5, 3 }, { 7, 4 } }, --goc ksgvn
		  damage_factor_z = { { 1, 1 }, { 4, 1 }, { 5, 2 }, { 7, 2 } }, --chinh theo vng
		}
	},
